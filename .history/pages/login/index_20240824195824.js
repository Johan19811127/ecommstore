        ...
        <form onSubmit={handleLogin} className="mt-4 space-y-2">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 mb-3 border font-semibold  border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-400 focus:outline-none placeholder:text-slate-6000"
            />
          </div>
