      ...
      <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
        ...
        <form onSubmit={handleLogin} className="mt-4 space-y-2">
          ...
          <button
            ...
            className="w-full flex items-center mb-shadow-md text-md border-b border-b-gray-300 justify-center px-4 py-2 font-semibold text-slate-900 bg-gray-200 rounded-xl hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75"
          >
