...
<p className="mt-4 text-blue-950 mb-3 ">Thank You for using the Monte Vista Online Store. If you are done shopping , fell free to clo0se this window or click backk to shop for more uniform items</p>
                <button
                    onClick={() => router.push('/')} 
