    ...
    <table className="w-[100%] border-collapse ">
      ...
      {cart.map((cartItem) => (
          ...
          <tr key={cartItem.item.id} className="">
            <td  className="py-2 px-auto  text-center"><Image src={cartItem.product.images[0]} width="40" height="50" className="mx-auto -my-2 "border border-gray-200" alt={cartItem.product.name}/></td>
