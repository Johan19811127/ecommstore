...
<p className="text-center text-sm">Your selected items are listed below. Please review them carefully before proceeding to checkout. Adjust the quantities or remove items if needed.</p>
...
<table>
  <tbody>
    ...
    <button className="py-2 px-5 mx-auto bg-red-500 text-white mt-2 rounded-lg "onClick={clearCart}>Clear Cart</button>
          ...
          <div className=" basis-1/1 md:basis-1/2 p-2 mt-3 flex-col flex"></div>
