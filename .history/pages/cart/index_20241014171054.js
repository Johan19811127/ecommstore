...
<table className="w-full">
  <tbody>
    ...
    <button className="py-2 px-5 mx-auto bg-red-500 text-white mt-2 rounded-lg "onClick={clearCart}>Clear Cart</button>
          ...
          {user ? (
          <p>As a logged in user you enjoy more benefits like quicker checkout and order tracking, Please always keep your information up to date to ensure that you receive your package as soon as possible and so we can communicate any circimsanses that might be a hold </p>
