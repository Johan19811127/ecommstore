...
<div className="min-h-[250px] lg:min-h-[500px] font-md mt-2 bborder rounded-lg shadow-sm">
    <table className="w-[100%] border-collapse ">
      <thead className=" ">
        ...
        <th className="py-2 px-2 border-left-gray-300 border text-left border-gray-300">Product</th>
 
        <th className="px-2 border-left-gray-300 border border-right-gray-300">Qty</th>
