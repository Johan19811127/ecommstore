...
<table className="w-full">
  <tbody>
    ...
    <button className="py-2 px-5 mx-auto bg-red-500 text-white mt-2 rounded-lg "onClick={clearCart}>Clear Cart</button>
          ...
          {user ? (
          <p className="text-sm text-start mb-4 leading-tight mx-">As a logged-in user, you unlock additional benefits such as faster checkout and real-time order tracking. Please ensure your account information is always up to date to guarantee timely delivery of your packages and swift resolution of any potential issues.</p>
          ):(
