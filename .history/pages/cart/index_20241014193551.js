  ...
  <tbody>
    ...
    <button className="py-2 px-5 mx-auto bg-red-500 text-white mt-2 rounded-lg "onClick={clearCart}>Clear Cart</button>
          ...
          <div className="flex flex-row">
            <div className="md:basis-2/3 flex flex-col px-3">

            <p className="text-sm text-start">Your Name and Surname</p>
            <input className="py-2 px-3 w-full boprder border-gray-200 rounded-md"></input>
            </div>
          </div>
