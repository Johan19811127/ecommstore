  ...
  <tbody>
    ...
    <button className="py-2 px-5 mx-auto bg-red-500 text-white mt-2 rounded-lg "onClick={clearCart}>Clear Cart</button>
          ...
          <div className="flex flex-row mt-3 gap-1">
            ...
            <div className="md:basis-3/12 flex flex-col px-2">
...
<div className="flex flex-row px-3 mb-2 gap-2">
      ...
      <p className="text-md text-start font-semibold mb-2">Amount:</p>
      </div>
      <div class="basis-1/2 flex flex-col col-md">
      <p className="text-md text-start font-semibold mb-2">R {formatAmount(Number(cartTotal).toFixed(2))} </p>
   </div>
   </div>
      <button className="py-2 px-5 mx-auto w-[60%] mt-3 bg-blue-500 text-white mt-2 rounded-lg " type="submit" disabled={processing}>
