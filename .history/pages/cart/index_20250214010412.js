...
<p className="text-start font-bold px-3  my-3">Your Information.</p>
   ...
   <input
    ...
    onClick={()=>AddCarttoDBHandler(cart)}
              className="py-2 px-5 shadow-md border-b-blue-950  border-r-blue-950 border-t-blue-400 border-l-blue-400  bg-blue-800 text-white rounded-lg w-full text-sm mx-auto uppercase font-semibold" >Proceed to Payment</inpout>
</form>  </div>
            </div>
