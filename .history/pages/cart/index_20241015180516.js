...
<table className="w-full">
  <tbody>
    ...
    <button className="py-2 px-5 mx-auto bg-red-500 text-white mt-2 rounded-lg "onClick={clearCart}>Clear Cart</button>
          ...
          <p className="text-sm text-start mb-4 leading-tight mx-5">Please choose your payment method below in order to continue. Please take note that if you choose EFT payment , we can not garentee you that your goods will still be available once your payment hads been verified due to the fact that stock can only be reserved with confirmed payment. Therefore where possible make payment via card. </p>
            </div>
      </div>
   </div>
