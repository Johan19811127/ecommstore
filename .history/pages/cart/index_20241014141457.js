...
<table>
  <tbody>
    <tr>
      ...
      <th className="w-[30%] border border-gray-300 text-xl font-semibold px-3 py-2">R {Number(cartTotal).toFixed(2)}</th>
    </tr>
  </tbody>
</table>
    <button className="py-2 px-5 mx-auto bg-red-500 text-white mt-2 rounded-"onClick={clearCart}>Clear Cart</button>
          </div>
