...
<div className="min-h-[350px] lg:min-h-[500px] border-gray-300 border drop-shadow-md">
    <table className="w-[100%] border-collapse ">
      <thead className="bg-blue-900 text-white">
        <th className="py-2 px-2"></th>
        <th className="py-2 px-2 border-left-blue-500 border border-right-blue-500">Product</th>
        <th className="py-2 px-2 border-left-blue-500 border border-right-blue-500">Size</th>
        <th className="py-2 px-2 border-left-blue-500 border border-right-blue-500">Qty</th>
        <th className="py-2 px-2 border-left-blue-500 border border-right-blue-500">Subtotal</th>
        <th className="py-2 px-2 border-left-blue-500 border border-right-blue-500"></th>
      ...
      {cart.map((cartItem) => (
          ...
          <tr key={cartItem.item.id}>
            <td  className="py-2 px-auto border border-gray-300 text-center"><Image src={cartItem.product.images[0]} width="60" height="75" className="mx-auto" alt={cartItem.product.name}/></td>
<td className="py-2 px-2 border border-gray-300">{cartItem.product.name}</td>
<td className="py-2 px-2 border border-gray-300">{cartItem.item.size}</td>
<td className="py-2 px-2 border border-gray-300"> <input
              type="number"
              ...
              min="1"
            /></td>
<td className="py-2 px-2 border border-gray-300">R {Number(cartItem.item.selling*cartItem.quantity).toFixed(2)}</td>
<td className="py-2 px-2 border border-gray-300"> <button onClick={() => handleRemoveItem(cartItem.product.id, cartItem.item.id)} className="bg-red-500 rounded-lg text-sm text-white font-semibold px-2 py-1">
             X
            </button></td>
