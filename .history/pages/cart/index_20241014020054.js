    ...
    <table className="w-[100%] border-collapse ">
      ...
      {cart.map((cartItem) => (
          ...
          <tr key={cartItem.item.id}>
            <td  className="py-2 px-2"><Image src={cartItem.product.images[0]} width="80" height="100" alt={cartItem.product.name}/></td>
...
<td className="py-2 px-2"> <button onClick={() => handleRemoveItem(cartItem.product.id, cartItem.item.id)} className="bg-red-500 rounded-lg text text-white font-semibold px-2 py-1">
             X
            </button></td>
