...
<div className=" basis-1/1 md:basis-6/12 mt-3 flex-col flex">
<div className="border-border-gray-200 shadow-md p-4 bg-white rounded-lg">
<h1 className="text-2xl text-blue-800 font-bold text-center mt-2 ">Your Cart</h1>
<p className="text-sm text-start">Your selected items are listed below. Please review them carefully before proceeding to checkout. Adjust the quantities or remove items if needed.</p>
...
<td className="py-2 px-2 text-left ">{cartItem.product.name}</td>
...
<table className="w-full">
  <tbody>
    ...
    <button className="py-2 px-5 mx-auto bg-red-500 text-white mt-2 rounded-lg "onClick={clearCart}>Clear Cart</button>
          ...
          <div className="border-border-gray-200 shadow-md p-4 bg-white rounded-lg">
          <h1 className="text-2xl text-blue-800 font-bold text-center mt-5 ">Your Details</h1>
          {user ? (
          <p className="text-sm text-start mb-4">As a logged-in user, you unlock additional benefits such as faster checkout and real-time order tracking. Please ensure your account information is always up to date to guarantee timely delivery of your packages and swift resolution of any potential issues.</p>
          ):(
            <p className="text-sm text-start mb-4">You are not currently logged in. to enjoy benefits like faster checkout and real-time order tracking please log in and complete your personal information page.</p>
          )}
          <div className="flex flex-row gap-3">
            <div className="md:basis-7/12 flex flex-col px-3">
          ...
          <div className="flex flex-row mt-3 gap-3">
            ...
            <textarea 
            className="py-2 px-3 w-full border border-gray-200 rounded-md"
            rows="4"></textarea>
            </div>
            </div>
          </div>
