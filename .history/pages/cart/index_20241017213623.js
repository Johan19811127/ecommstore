...
<td className="py-2 px-2 text-left leading-tight text-sm  border border-bottom-gray-200">{` ${cartItem.product.name} - ${cartItem.item.size}  `}</td>

<td className="py-2 px-2  border border-bottom-gray-200"> <input
              type="number"
              ...
              min="1"
            /></td>
<td className="py-2 px-2  border border-bottom-gray-200">R {Number(cartItem.item.selling*cartItem.quantity).toFixed(2)}</td>
