          ...
          <div className="flex flex-row mt-3 gap-3">
            ...
            <div className="flex flex-col lg:flex-row px-3 mt-3 p-2 gap-2">
             ...
             < div className="basis-1/1 lg:basis-1/3 items-center px-3 mt-2">
              <form action="https://www.p{formatAmount(Number(cartTotal).toFixed(2))}ayfast.co.za/eng/process" method="post">
   <input type="hidden" name="merchant_id" value="10037116"/>
   <input type="hidden" name="merchant_key" value="ea1brspu76ire"/>
   <input type="hidden" name="amount" value={formatAmount(Number(cartTotal).toFixed(2))}/>
   <input type="hidden" name="item_name" value="Test Product"/>
   <button
    type="submit"
    onClick={()=>AddCarttoDBHandler(cart)}
              className="py-2 px-5 shadow-md border-b-blue-950  border-r-blue-950 border-t-blue-400 border-l-blue-400  bg-blue-800 text-white rounded-lg w-full text-sm mx-auto uppercase font-semibold" >Proceed to Payment</button>
</form>  </div>
            </div>
