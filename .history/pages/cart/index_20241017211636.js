...
<div className="min-h-[350px] lg:min-h-[500px] font-md mt-2 border-gray-300 border rounded-lg shadow-sm">
    <table className="w-[100%] border-collapse ">
      <thead className="bg-blue-900 text-white">
        <th className="py-2 px-2"></th>
        <th className="py-2 px-2 border-left-gray-300 border text-left border-right-gray-300">Product</th>
 
        <th className="2 px-2 border-left-gray-300 border border-right-gray-300">Qty</th>
