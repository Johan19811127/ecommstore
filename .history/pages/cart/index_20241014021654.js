...
<div className="basis-1/2 p-2 flex-col flex">
<div className="min-h-[350pxlg:min-h-[500px]">
    <table className="w-[100%] border-collapse ">
      ...
      {cart.map((cartItem) => (
          ...
          <tr key={cartItem.item.id}>
            <td  className="py-2 px-2 border border-gray-300 text-center"><Image src={cartItem.product.images[0]} width="60" height="75" alt={cartItem.product.name}/></td>
