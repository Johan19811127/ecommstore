...
<div className="min-h-[350px] lg:min-h-[500px] border-gray-300 border rounded-lg shadow-md">
    <table className="w-[100%] border-collapse ">
      <thead className="bg-blue-900 text-white">
        ...
        <th className="py-2 px-2 border-left- border border-right-">Product</th>
        <th className="py-2 px-2 border-left- border border-right-">Size</th>
        <th className="py-2 px-2 border-left- border border-right-">Qty</th>
        <th className="py-2 px-2 border-left- border border-right-">Subtotal</th>
        <th className="py-2 px-2 border-left- border border-right-"></th>
