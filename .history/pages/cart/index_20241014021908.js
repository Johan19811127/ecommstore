    ...
    <table className="w-[100%] border-collapse ">
      ...
      {cart.map((cartItem) => (
          ...
          <tr key={cartItem.item.id}>
            <td  className="py-2 px-2 border border-gray-300 text-center"><Image src={cartItem.product.images[0]} width="60" height="75" className="" alt={cartItem.product.name}/></td>
