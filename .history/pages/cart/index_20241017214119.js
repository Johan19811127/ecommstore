...
<div className="lg:w-[80vw] md:w-[100vw] w-full mx-auto">
...
<div className=" basis-1/1 lg:basis-4/12 mt-3 flex-col flex ">
...
<div className="min-h-[250px] lg:min-h-[500px] font-md mt-2 bborder rounded-lg shadow-sm">
    <table className="w-[100%] border-collapse ">
      <thead className=" ">

        <th className="py-2 px-2 border-left-gray-300 border text-left border-gray-500" colspan="2">Product</th>
 
        <th className="px-2 border-left-gray-300 border border-gray-500">Qty</th>
        <th className="py-2 px-2 border-left-gray-300 border border-gray-500">Subtotal</th>
      ...
      {cart.map((cartItem) => (
          ...
          <tr key={cartItem.item.id} className="">
            <td  className="py-2 px-auto  text-center border border-b-gray-400"><Image src={cartItem.product.images[0]} width="40" height="50" className="mx-auto -my-2" alt={cartItem.product.name}/></td>
<td className="py-2 px-2 text-left leading-tight text-sm  border border-b-gray-400">{` ${cartItem.product.name} - ${cartItem.item.size}  `}</td>

<td className="py-2 px-2  border border-b-gray-400"> <input
              type="number"
              ...
              min="1"
            /></td>
<td className="py-2 px-2  border border-b-gray-400">R {Number(cartItem.item.selling*cartItem.quantity).toFixed(2)}</td>
<td className="py-2 px-2 "> <button onClick={() => handleRemoveItem(cartItem.product.id, cartItem.item.id)} className="bg-red-500 rounded-lg text-xs text-white font-semibold px-2 py-1">
             X
            </button></td>
