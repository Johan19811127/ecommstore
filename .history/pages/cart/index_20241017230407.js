...
<div className="border-border-gray-200 shadow-md py-4 px-5 bg-white rounded-lg">
...
<div className="min-h-[250px] lg:min-h-[500px] font-md mt-2 rounded-lg shadow-sm">
    <table className="w-[100%] border-collapse ">
      <thead className=" ">

        <th className="py-2 px-2 border-left-gray-300 border text-left border-gray-600" colspan="2">Product</th>
 
        <th className="px-2 border-left-gray-300 border border-gray-600">Qty</th>
        <th className="py-2 px-2 border-left-gray-300 border border-gray-600">Subtotal</th>
...
<td className=" py-2"> <input
              type="number"
              className="p-2 border border-gray-400 text-center text-sm rounded-lg w-[55px]"
              ...
              min="1"
            /></td>
<td className="py-2 px-2 text-sm ">R {Number(cartItem.item.selling*cartItem.quantity).toFixed(2)}</td>
...
<table className="w-full">
  <tbody>
    <tr>
      ...
      <th className="w-[30%]   text-md font-semibold px-4 py-2 text-end">Total</th>
      <th className="w-[30%] text-md font-semibold px-3 py-2">R {formatAmount(Number(cartTotal).toFixed(2))}</th>
    </tr>
  </tbody>
</table>
