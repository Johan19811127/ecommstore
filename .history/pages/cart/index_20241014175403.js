...
<div className=" basis-1/1 md:basis-1/2 p-2 mt-3 flex-col flex">
...
<p className="text-sm">Your selected items are listed below. Please review them carefully before proceeding to checkout. Adjust the quantities or remove items if needed.</p>
...
<table className="w-full">
  <tbody>
    ...
    <button className="py-2 px-5 mx-auto bg-red-500 text-white mt-2 rounded-lg "onClick={clearCart}>Clear Cart</button>
          ...
          <div className=" basis-1/1 md:basis-1/2 mt-3 flex-col flex">
          
          <div className="border-border-gray-200 shadow-md p-4 bg-white rounded-lg">
          <h1 className="text-2xl text-blue-800 font-bold text-center mt-5 ">Your Details</h1>
          {user ? (
          <p className="text-sm text-start">As a logged-in user, you unlock additional benefits such as faster checkout and real-time order tracking. Please ensure your account information is always up to date to guarantee timely delivery of your packages and swift resolution of any potential issues.</p>
          ):(
            <p className="text-sm text-start">You are not currently logged in. to enjoy benefits like faster checkout and real-time order tracking please log in and complete your personal information page.</p>
          )}
          </div>
