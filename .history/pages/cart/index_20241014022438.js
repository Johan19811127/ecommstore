...
<div className="min-h-[350px] lg:min-h-[500px] border-gray-300 border drop-shadow-md">
    <table className="w-[100%] border-collapse ">
      <thead className="bg-blue-900 text-white">
        ...
        <th className="py-2 px-2 border-left-white border border-right-white">Qty</th>
        <th className="py-2 px-2 border-left-white border border-right-white">Subtotal</th>
        <th className="py-2 px-2 border-left-white border border-right-white"></th>
