...
export default function PaymentSuccess() {
    ...
    const msg = "We have received your order. Normally orders are completed within 5 working days. You order will be delivered straight to the learners class. To track your order pleae"
