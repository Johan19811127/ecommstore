...
<li className="text-blue-950 vleading-tight mb-2">Your order is currently being processed. You can track its status by logging into your account and navigating to your profile via the navigation bar by clicking on your email.</li>
...
<p className="mt-4 text-blue-950 mb-5 px-4 ">Thank you for shopping with the Monte Vista Online Store.<br></br> If you have completed your purchase, you may close this window or click back to continue shopping for more uniform items.</p>
                <button
                    onClick={() => router.push('/')} 
