          ...
          <div className="px-5">
            ...
            {productItems.length === 1 && (
              <>
                ...
                <p className="align-middle font-medium text-gray-700">
                  In Stock: <span className="ml-4 text-blue-900 antialiased uppercase">{productItems[0].quantity}</span>
                </p>
              </>
            )}
                ...
                {productItems.map((size) => (
                  <button
                    ...
                    className={`text-md font-semibold py-2 px-4 rounded-lg flex-grow-0 flex-shirk-0 ${
                      selItem.size === productItem.size ? 'bg-blue-600 text-white' : 'bg-gray-300'
                    }`}
                  >
                    {size.size}
                  </button>
