...
<p className="mt-4 mb-1 uppercase text-slate-800 font-bold">Pricing and Stock on Hand:</p>
              <p className="text-default "> Size: <span className="text-lg font-semibold ml-110 antialiased uppercase">{product.sizes[0].size}</span> </p>
              ...
              <p className="text-default "> Stock On Hand: <span className="text-lg font-semibold ml-5 uppercase"> {product.sizes[0].quantity}</span> </p>
            </div></>
          )}
