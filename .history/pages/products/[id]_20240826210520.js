...
<div className="basis-1/4">
               <p className="text-blue-900 antialiased uppercase text-end ml=auto">{selItem.size}</p>
               </div>
               </div>
               <div className="container flex flex-row">
                ...
                <div className="basis-1/4"><p className="text-blue-900 font-semiboldantialiased uppercase text-end ml-auto">R {Number(selItem.selling).toFixed(2)}</p></div></div>
                <div className="container flex flex-row">
                ...
                <div className="basis-1/4"><p className="text-blue-900 antialiased uppercase text-end ml-auto">{selItem.quantity}</p>"
                </div></div>
              </>
            )}
