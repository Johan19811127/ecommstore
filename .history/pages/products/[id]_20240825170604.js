...
import { FacebookMessengerShareButton, TwitterShareButton,FacebookShareButton,XIcon,InstapaperShareButton,EmailShareButton,WhatsappShareButton,FacebookIcon,FacebookMessengerIcon,TwitterIcon,EmailIcon,WhatsappIcon,InstapaperIcon} from 'react-share';
...
<p className="mt-5 mb-5 uppercase text-blue-900 font-bold ">Item Description:</p>
          <p className="text- text-gray-700 leading-tight text-justify">{product.description}</p>
