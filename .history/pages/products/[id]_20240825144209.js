  ...
  return (
    <div className="container mx-auto mt-8 lg:w-[1200px] p-4">
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div>
          <h1 className="text-4xl font-bold text-blur-800">{product.name}</h1>
...
<p className="mt-4 mb-1 uppercase text-slate-800 font-bold">Pricing and Stock on Hand:</p>
              <p className="text-default "> Size: <span className="text-lg font-semibold ml-10 antialiased uppercase">{product.sizes[0].size}</span> </p>
              <p className="text-default "> Price: <span className="text-lg font-semibold ml-9 uppercase">R {Number(product.sizes[0].selling).toFixed(2)}</span> </p>
              <p className="text-default "> In Stock: <span className="text-lg font-semibold ml-4 uppercase"> {product.sizes[0].quantity}</span> </p>
            </div></>
          )}
