...
export default function ProductDetail() {
  ...
  return (
    <div classame="h-screen w-screen bg-gray-100">  
    <Navbar></Navbar>
    <NavLinks></NavLinks>
    <div className="container bg-white mx-auto mt-8 lg:w-[1200px] p-4">
...
<p className="mt-4 mb-1 uppercase text-blue-900 font-bold">Pricing and Stock on Hand:</p>
              <p className="align-middle		font-medium text-gray-700"> Size: <span className="text-lg font-semibold ml-11 text-blue-900  antialiased uppercase">{product.sizes[0].size}</span> </p>
              <p className="align-middle	font-medium	 text-gray-700"> Price: <span className="text-lg font-semibold ml-9 text-blue-900 antialiased uppercase">R {Number(product.sizes[0].selling).toFixed(2)}</span> </p>
              <p className="align-middle	font-medium	text-gray-700"> In Stock: <span className="text-lg font-semibold ml-4 text-blue-900 antialiased uppercase"> {product.sizes[0].quantity}</span> </p>
            </div></>
          )}
