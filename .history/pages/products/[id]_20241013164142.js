      ...
      <div className="container bg-white mx-auto mt-8 lg:w-[1200px] p-4 rounded-lg">
        <div className="grid md:grid-cols-2 gap-3 items-center">
          ...
          <div className="px-5">
            ...
            {productItems.length > 1 && (
              <>
               <p className="mb-3 text-blue-800 text-md">Kindly refer to the <a href="/products/sizes" class="font-semibiold">sizing charts </a>to ensure the perfect fit for your selection.</p>
