    ...
    <div className="h-screen w-screen bg-gray-100">
      ...
      <div className="container bg-white mx-auto mt-8 lg:w-[1200px] p-4 rounded-lg">
        <div className="grid md:grid-cols-2 gap-3 items-center">
          ...
          <div className="px-5">
            <h1 className="text-4xl font-bold text-gray-800 capitalised">{product.name}</h1>

            <p className="mt-5 mb-5 uppercase text-gray-900 font-bold">Item Description:</p>
            ...
            {productItems.length > 1 && (
              <>
                ...
                <p className="mb-3 text-gray-900 text-sm">Kindly refer to the <a href="/products/sizes">sizing charts </a>to ensure the perfect fit for your selection.</p>
                ...
                {selItem && (
                  <>
                    ...
                    <div className="flex flex-row">
                      ...
                      <p className="ml-2 text-blue-900 antialiased uppercase">{selItem.size}</p>
                    </div>
                    <div className="flex flex-row">
                      <p className="align-middle text-gray-700">Price: </p>
                      <p className="ml-2 text-blue-900 antialiased uppercase">R {Number(selItem.selling).toFixed(2)}</p>
                    </div>
                    <div className="flex flex-row">
