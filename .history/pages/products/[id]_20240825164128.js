...
import { FacebookMessengerShareButton, TwitterShareButton,FacebookShareButton,InstapaperShareButton,EmailShareButton,WhatsappShareButton,FacebookIcon,FacebookMessengerIcon,TwitterIcon,EmailIcon,WhatsappIcon,InstapaperIcon} from 'react-share';
...
<p className="mt-5 mb-5 uppercase text-blue-900 font-bold">Pricing and Stock on Hand:</p>
<p className="mt-4 mb-1 uppercase text-blue-900 font-bold">Pricing and Stock on Hand:</p>
          ...
          <div className="flex flex-row content-center items-center my-3">
               <FacebookShareButton
          url={currentUrl}
