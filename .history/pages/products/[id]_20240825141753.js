        ...
        <div>
          ...
          {product.sizes && product.sizes.length === 1 && (
            ...
            <><div className="border border-t-slate-500 w-[50%] mt-8 "></div><div className="mt-4  rounded-lg">
              ...
              <p className="text-default "> Size: <span className="text-lg font-semibold ml-5 c">{product.sizes[0].size}</span> </p>
              <p className="text-default "> Price: <span className="text-lg font-semibold ml-5 text-lg font-semibold ml-5">R {Number(product.sizes[0].selling).toFixed(2)}</span> </p>
