...
<p className="mt-4 mb-1 uppercase text-blue-900 font-bold">Pricing and Stock on Hand:</p>
              <p className="align-middle		font text-gray-700"> Size: <span className="text-lg font-semibold ml-11 text-blue-900  antialiased uppercase">{product.sizes[0].size}</span> </p>
