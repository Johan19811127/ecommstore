...
<p className="mt-4 mb-1 uppercase text-blue-900 font-bold">Pricing and Stock on Hand:</p>
              ...
              <p className="align-middle		text-gray-700"> In Stock: <span className="text-lg font-semibold ml-4 text-blue-900 antialiased uppercase"> {product.sizes[0].quantity}</span> </p>
            </div></>
          )}
