            ...
            {productItems.lenght === 1 && (
              <>
                ...
                <p className="align-middle font-medium text-gray-700">
                  Size: <span className="ml-11 text-blue-900 antialiased uppercase">{productItems.size}</span>
                </p>
                <p className="align-middle font-medium text-gray-700">
                  Price: <span className="ml-9 text-blue-900 antialiased uppercase">R {Number(productItems.selling).toFixed(2)}</span>
                </p>
                <p className="align-middle font-medium text-gray-700">
...
<div className="basis-1/4">
               ...
               <div className="container flex flex-row">
                ...
                <div className="basis-1/4"><p className="text-blue-900 antialiased font-semibold uppercase text-end ml-auto">{selItem.quantity}</p>"
                </div></div>
              </>
            )}
