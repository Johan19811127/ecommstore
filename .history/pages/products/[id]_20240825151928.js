...
<p className="mt-4 mb-1 uppercase text-blue-900 font-bold">Pricing and Stock on Hand:</p>
              ...
              <p className="text-default font-medium text-gray-700"> Price: <span className="text-lg font-semibold ml-9 text-blue-900 antialiaseduppercase">R {Number(product.sizes[0].selling).toFixed(2)}</span> </p>
