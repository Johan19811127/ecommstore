      ...
      <div className="container bg-white mx-auto mt-8 lg:w-[1200px] p-4 rounded-lg">
        <div className="grid md:grid-cols-2 gap-3 items-center">
          ...
          <div className="px-5">
            ...
            {productItems.length > 1 && (
              <>
               <p className="mb- text-blue-800 text-sm">Refer to the <a href="/products/sizes" className="font-semibold text-lg">sizing charts </a>to ensure the perfect fit for your selection.</p>
