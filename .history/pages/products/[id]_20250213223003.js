              ...
              <>
                ...
                {selItem && (
                 ...
                 <div className="basis-1/6">
                      ...
                      <p className="ms-3 text-lg font-semibold antialiased uppercase text-end">{selItem.size}</p></div>
                    </div>
                    <div className="flex flex-row"> <div className="basis-1/6">
                      <p className="align-middle text-gray-700">Price: </p></div>
                      <div className="basis-2/6 text-end">
                      <p className='ms-3 text-lg font-semibold text-red-600 text-end'>
...
{selItem.selling}
                    ...
                    <div className="basis-1/6">
                      ...
                      <div className="basis-2/6 text-end">
                      <p className="ms-3 text-lg font-semibold antialiased uppercase">{selItem.totalOnHand}</p></div>
                    </div>
                  </>
                )}
              </>
