...
<p className="mt-5 mb-5 uppercase text-blue-900 font-bold leading-tight text-justify">Item Description:</p>
...
<p className="mt-4 mb-1 uppercase text-blue-900 font-bold">Pricing and Stock on Hand:</p>
              <p className="text-default font-medium  text-gray-700"> Size: <span className="text-lg font-semibold ml-10 text-blue-900  antialiased uppercase">{product.sizes[0].size}</span> </p>
              <p className="text-default font-medium text-gray-700"> Price: <span className="text-lg font-semibold ml-9 text-blue-900 uppercase">R {Number(product.sizes[0].selling).toFixed(2)}</span> </p>
              <p className="text-default font-medium text-gray-700"> In Stock: <span className="text-lg font-semibold ml-4 text-blue-900 uppercase"> {product.sizes[0].quantity}</span> </p>
            </div></>
          )}
