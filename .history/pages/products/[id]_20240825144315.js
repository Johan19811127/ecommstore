...
<p className="mt-4 mb-1 uppercase text-slate-800 font-bold">Pricing and Stock on Hand:</p>
              <p className="text-default text"> Size: <span className="text-lg font-semibold ml-10 antialiased uppercase">{product.sizes[0].size}</span> </p>
              <p className="text-default text"> Price: <span className="text-lg font-semibold ml-9 uppercase">R {Number(product.sizes[0].selling).toFixed(2)}</span> </p>
              <p className="text-default text"> In Stock: <span className="text-lg font-semibold ml-4 uppercase"> {product.sizes[0].quantity}</span> </p>
            </div></>
          )}
