...
export default function SizeCharts() {
  return (
    <div>
        ...
        <p className="text-md text-blue-800 text-justify mb-5 leading-tight">Before we dive into each product's chart, let's first clarify the terms used in the tables.</p>
