    ...
    <div>
        ...
        <div className="grid lg:grid-cols-2 gap-3 align-items-center mt-5">
            <div className="flex flex-row card border border-slate-200 shadow-md rounded-lg bg-white">
                ...
                <p className="text-md text-blue-800 text-centermb-5"> Wrap a measurement tape snug , but not to tight ,  around the waist just above the hips. </p><p className="text-sm text-center text-blue-600">**Measurement in centimeters. </p>
                </div>
            </div>
