    ...
    <div>
        ...
        <div className="grid lg:grid-cols-2 gap-3 align-items-center mt-5">
            ...
            <div className="flex flex-row card border border-slate-200 shadow-md rounded-lg mb-3 bg-white">
                ...
                <p className="text-md text-blue-800 text-justify mb-5 leading-tight"> start at the outer edge of the shoulder and extend the measuring tape down the arm to the base of the palm, just before the wrist. </p><p className="text-sm text-center text-blue-600">**Measurement in centimeters. </p>
                </div>
            </div>
