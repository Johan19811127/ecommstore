  ...
  return (
    <div>
        ...
        <div className="grid lg:grid-cols-2 gap-3 align-items-center mt-5">
            <div className="flex flex-row card border border-slate-200 shadow-md rounded-lg bg-gray-50">
                <div className="basis-1/2 bg-blue-300">
                <Image src="/waist.png" width="400" height="400" alt="waist" className="drop-shadow-md rounded-l-lg'></Image>
                </div>
                <div className="basis-1/2 content-center justify-center p-3  ">
                <h3 className="text-2xl font-semibold antialiased  text-blue-800 text-center">Waist.</h3>
                </div>
            </div>
