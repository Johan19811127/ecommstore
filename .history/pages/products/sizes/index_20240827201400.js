    ...
    <div>
        ...
        <div className="grid lg:grid-cols-2 gap-3 align-items-center mt-5">
            ...
            <div className="flex flex-row card border border-slate-200 shadow-md rounded-lg bg-white">
                ...
                <p className="text-md text-blue-800 text-justify mb-5 leading-tight"> lace the measuring tape at the outer edge of one shoulder and extend it straight across the back to the outer edge of the other shoulder.. </p><p className="text-sm text-center text-blue-600">**Measurement in centimeters. </p>
                </div>
            </div>
