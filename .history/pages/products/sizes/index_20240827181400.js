...
export default function SizeCharts() {
  return (
    <div>
        ...
        <p className="font-semibold text-blue-700 text-center antialiased my-3">At [Your Store Name], we want you to find the perfect fit! Our sizing charts are here to help you choose the best size for your garments. Please note that due to variations in manufacturing, sizes may vary slightly from one garment to another.
