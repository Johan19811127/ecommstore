...
<p className="mt-4 mb-1 uppercase text-blue-900 font-bold">Pricing and Stock on Hand:</p>
            ...
            {sizes.map((size) => (
              <button type="button" className="bg-blue-700 py-2 px-4 rounded-lg flex-grow " key={size.size} >
            ...
            <div className="my-5 flex flex-row gap-3 items-center ">
              <div className="basis-1/3 pr-5"><p className="align-middle	font-medium	text-gray-700">Items required</p></div>
              <div className="basis-1/3 pl-5">  <input
                      type="number"
                      name="selling"
                      value={qty}
                      onChange={setQty}
