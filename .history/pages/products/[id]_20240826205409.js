            ...
            {product.sizes && product.sizes.length > 1 && (
              ...
              <p className="mt-5 mb-3 uppercase text-blue-900 font-bold">Pricing and Stock on Hand for all variants:</p>
                ...
                <p className="align-middle font-medium text-gray-700">
                  ...
                  Size: <span className="ml-11 text-blue-900 antialiased uppercase text-end ml-=auto">{selItem.size}</span>
                </p>
                <p className="align-middle font-medium text-gray-700">
                  Price: <span className="ml-9 text-blue-900 antialiased uppercase text-end ml-auto">R {Number(selItem.selling).toFixed(2)}</span>
                </p>
                <p className="align-middle font-medium text-gray-700">
                  In Stock: <span className="ml-4 text-blue-900 antialiased uppercase text-end ml-auto">{selItem.quantity}</span>
                </p>
                </div>
              </>
            )}
