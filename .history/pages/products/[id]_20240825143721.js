...
<p className="mt-4 mb-1 uppercase text-slate-800 font-bold">Pricing and Stock on Hand:</p>
              <p className="text-default "> Size: <span className="text-lg font-semibold ml-12 antialiased uppercase">{product.sizes[0].size}</span> </p>
              <p className="text-default "> Price: <span className="text-lg font-semibold ml-11 uppercase">R {Number(product.sizes[0].selling).toFixed(2)}</span> </p>
