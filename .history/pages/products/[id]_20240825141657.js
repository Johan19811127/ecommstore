        ...
        <div>
          ...
          {product.sizes && product.sizes.length === 1 && (
            ...
            <><div className="border border-t-slate-500 w-[50%] mt-8 "></div><div className="mt-4  rounded-lg">
              ...
              <p className="text-default font-semibold"> Size: <span className="text-lg font-semnibold ml-5">{product.sizes[0].size}</span> </p>
              <p className="text-default font-semibold"> Price: <span className="ml-5">R {Number(product.sizes[0].selling).toFixed(2)}</span> </p>
