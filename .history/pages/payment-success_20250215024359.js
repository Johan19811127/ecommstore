...
<p className="text-sm text-blue-900">If you are done shopping, you may close this window or click the button below to continue shopping for more uniform items.</p>
                <button
                    onClick={() => router.push('/')} 
