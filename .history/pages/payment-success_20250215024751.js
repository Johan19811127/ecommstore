...
export default function PaymentSuccess() {
    ...
    const msg = "Thank YouWe have received your order. Normally orders are completed within 5 working days. You order will be delivered straight to the learners class. To track your order please log in to your account and  and navigating to your profile via the navigation bar by clicking on your email."
...
<p className="text-sm text-blue-900">If you are done shopping, you may close this window or click the button below to continue shopping.</p>
                <button
                    onClick={() => router.push('/')} 
                    className="mt-6 px-4 py-2 bg-blue-900 text-white rounded-md font-semibold hover:bg-blue-700 shadow-md border-b-2"
                >
                    BACK TO STORE
                </button>
            </div>
