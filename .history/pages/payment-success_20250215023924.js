...
<p className="mt-4 text-blue-950 mb-5 px-4 ">Thank you for using the Monte Vista Online Store</If you have completed your purchase, you may close this window or click back to continue shopping for more uniform items.</p>
                <button
                    onClick={() => router.push('/')} 
