...
export default function SupplierForm() {
 ...
 <Adminlayout>
    ...
    <form onSubmit={handleSubmit} className="max-w-5xl mx-auto p-8 bg-white shadow-lg rounded-lg">
      <h2 className="text-2xl font-semibold mb-6">New Supplier Form</h2>
...
<option>Transactional</option>
      ...
      <button
        type="submit"
        className="w-full px-10 py-2 bg-blue-700 text-white font-semibold rounded-md shadow hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:ring-opacity-75"
      >
        Submit
      </button>
    </form>
