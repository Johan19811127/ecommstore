...
<option>Transactional</option>
      ...
      <button
        type="submit"
        className="w-96 mx-10 py-2 bg-blue-700 text-white font-semibold rounded-md shadow hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:ring-opacity-75"
      >
        Submit
      </button>
    </form>
