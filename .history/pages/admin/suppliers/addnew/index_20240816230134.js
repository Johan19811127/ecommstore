...
<div className="mb-4 md:basis-1/4">
        ...
        <input
          ...
          required
          className="mt-1 block md: w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
        />
      </div>
      <div className="mb-4 md:basis-3/4">
