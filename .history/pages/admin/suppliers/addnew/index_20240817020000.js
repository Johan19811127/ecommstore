...
<div className="grid grid-cols-8 gap-4 mb-4">
        <div className="col-span-2">
          <label className="block text-sm font-medium text-gray-700" htmlFor="accotype">
           Account Type
          </label>
          <select
            type="text"
...
<option>Transactional</option>
      ...
      <button
        type="submit"
        className="max-w-xl px-10 py-2 bg-blue-900 mx-auto text-white font-semibold rounded-md shadow hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:ring-opacity-75"
      >
        Submit
      </button>
    </form>
