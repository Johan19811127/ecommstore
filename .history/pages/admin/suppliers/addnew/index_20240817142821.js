...
export default function SupplierForm() {
 ...
 <Adminlayout>
  ...
  <div className="block w-100  h-auto">
    <h1 className="text-2xl font-bold leading-tight mb-5">Add a new Supplier</h1>
  </div>
    <form onSubmit={handleSubmit} className="max-w-5xl mx-auto p-8 bg-white shadow-lg rounded-lg">
      <h2 className="text-2xl font-semibold mb-6">Supplier Form</h2>
