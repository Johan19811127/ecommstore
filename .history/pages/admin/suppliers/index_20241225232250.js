                ...
                <div className="flex flex-col items-center justify-items-center h-full">
                    <div className="bg-white rounded-md border border-gray-300 drop-shadow-md w-[90%] min-h-[80vh] mt-5 ">
                      ...
                      <div className="flex flex-row p-3">
                        <p className="basis-1/12">Search</p>
                        <input className="basis-3/12 py-2 px-3 rounded border border-gray-300"
                        type="text"
                        value={search}
                        onChange={(e) => setSearch(e.target.value)}
                        placeholder="search"/>
                   <div className="basis-1/1 lg:basis-3/12 flex flex-col "></div>
                      <div className="flex  flex-col md:flex-row basis-4/4/8 p-3 gap-5 flex-1 items-center justify-center">
