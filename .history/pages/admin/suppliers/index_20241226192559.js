    ...
    <div>
        <Adminlayout>
                ...
                <div className="flex flex-col items-center justify-items-center h-full">
                    <div className="bg-white rounded-md  w-[90%] min-h-[80vh] my-auto ">
                  ...
                  <div className="p-3">
                      <div className="flex flex-row p-3 items-center justify-center">
                        ...
                        <input className="basis-3/12 py-2 px-3 rounded border border-gray-500"
                        type="text"
                        value={search}
                   ...
                   <div className="basis-1/1 lg:basis-4/12 flex flex-col "></div>
                      ...
                      <table className="w-full">
                        <thead className="border border-b-gray-300  bg-blue-900 text-white mb-2">
                            ...
                            <th className="w-[25%] font-semibold text-md py-1 px-2 text-star border border-wehitet">Name</th>
