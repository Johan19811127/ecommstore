                    ...
                    <div className="bg-white rounded-md border border-gray-300 drop-shadow-md w-[80%] mt-5 p-5">
                      <table className="w-full">
                        <thead className="border border-b-gray-300 mb-2">
                            ...
                            <th className="w-[25%] font-medium text-md py-1 px-3 text-start">Name</th>
                            <th className="w-[20%] font-medium text-md py-1 px-3 text-start">Contact</th>
                            <th className="w-[15%] font-medium text-md py-1 px-3 text-start">Phone Number</th>
                        ...
                        {suppliers.map((supplier, idx) => (
                            <tr>
<td className="text-sm px-2">{idx +1}</td>
<td>{supplier.name}</td>
