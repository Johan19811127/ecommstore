        ...
        <Adminlayout>
                ...
                <div className="flex flex-col items-center justify-items-center h-full">
                    <div className="bg-white rounded-md border border-gray-300 drop-shadow-md w-[90%] min-h-[80vh] mt-5 ">
                      ...
                      <p className="text-white text-sm leading-tight">Add, Edit or Delete suppliers. You can filter the list of suppliers by searching for your supplier by any  You also get access to the supplier invoice to add stock.</p>
                      </div>
