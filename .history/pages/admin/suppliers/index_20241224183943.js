            ...
            <div className="w-full p-3 border border-b-gray-300 bg-white shadow-md ">
                ...
                <div className="flex flex-col items-center justify-items-center h-full">
                    ...
                    <div className="flex  flex-col md:flex-row p-3 gap-3">
                      <button className="button bg-blue-700 text-white rounded border border-b-font-bold py-2 px-5 basis-1/1 lg:basis-1/3"><Link href="/admin/suppliers/addnew">ADD NEW SUPPLIER</Link></button>
                      </div>
