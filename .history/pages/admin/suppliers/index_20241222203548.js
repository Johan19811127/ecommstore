...
<td className="text-sm px-2 py-1 text-gray-900"><Link href="/admin/suppliers/edit/{supplier._id}" className="py1 px-3 bg-blue-500 text-white font-semibold text-sm uppercase rounded-sm">EDIT</Link> </td>
                            </tr>
