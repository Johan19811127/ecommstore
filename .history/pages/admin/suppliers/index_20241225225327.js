...
import { LuHeartHandshake } from 'react-icons/hi';
        ...
        <Adminlayout>
                ...
                <div className="flex flex-col items-center justify-items-center h-full">
                    <div className="bg-white rounded-md border border-gray-300 drop-shadow-md w-[90%] min-h-[80vh] mt-5 ">
                      ...
                      <HiUserGroup className="w-[60px] h-[60px] text-white basis-1/8"/></div>
                      <div className="basis-7/8 items-start flex flex-1 flex-col">
                      <h1 className="text-xl text-white font-bold">Suppliers</h1>
                      <p className="text-white text-md leading-tight">Add, Edit or Delete suppliers. You also get access to the supplier invoice to add stock.</p>
                      </div>
