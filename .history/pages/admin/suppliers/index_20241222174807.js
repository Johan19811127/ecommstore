                    ...
                    <div className="bg-white rounded-md border border-gray-300 drop-shadow-md w-[80%] mt-5 p-5">
                      <table className="w-full">
                        <thead className="border border-b-gray-300 mb-2">
                            <th className="w-[5%] font-medium text-md py-1 px-2"></th>
                            ...
                            <th className="w-[20%] font-medium text-md py-1 px-2 text-start">Email</th>
                            <th className="w-[10%] font-medium text-md py-1 px-2">Edit</th>
                        </thead>
                        {suppliers.map((supplier, idx) => (
                            <tr>
<td className="text-sm px-2 py-1">{idx +1}</td>
<td className="text-sm px-2 py-1">{supplier.name}</td>
<td className="text-sm px-2 py-1">{supplier.contact}</td>
<td className="text-sm px-2 py-1">{supplier.phone}</td>
<td className="text-sm px-2 py-1">{supplier.email}</td>
<t dclassName="text-sm px-2 py-1"></td>
                            </tr>
