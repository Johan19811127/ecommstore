...
<td className="text-sm px-2 py-1 text-gray-900 text"><Link href="/admin/suppliers/edit/{supplier._id}" className="py-1 px-3 bg-blue-700 mx-auto text-white font-semibold text-sm uppercase rounded-sm">EDIT</Link> </td>
                            </tr>
