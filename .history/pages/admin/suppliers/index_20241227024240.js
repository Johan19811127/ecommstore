...
<td className="text-sm px-2 py-1 text-gray-900 text-center"><Link href="/admin/suppliers/edit/{supplier._id}" className="py-1 px-3 bg-blue-700 mx-auto text-white font-semibold text-sm uppercase rounded-sm">EDIT</Link> </td>
                    ...
                    <div className="flex flex-row bg-white w-full p-5">
                      <div className="flex basis-1/3">
                      
                    </div>
  <div className="flex basis-1/3">
                      <p className="text-sm text-center mx-auto">Monte Vista Primary School</p>
                      </div>           
                      <div className="flex flex-row basis-1/3">
                      <p className="basis-10/12 text-sm text-end px-2">No of Suppliers showing:</p>
                      <p className="basis-2/12 text-sm px-2">{noOfSup}</p>
                      </div>       
                        </div>
