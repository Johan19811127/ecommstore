                ...
                <div className="flex flex-col items-center justify-items-center h-full">
                    <div className="bg-white rounded-md border border-gray-300 drop-shadow-md w-[90%] min-h-[80vh] mt-5 ">
                      ...
                      <div className="flex flex-row p-3">
                        <p className="basis-2/8">Search</p>
                        <input className="basis-3/8 py-2 px-3 rounded border border-gray-300"
                        type="text"
                        value={search}
                        onChange={(e) => setSearch(e.target.value)}
                        placeholder="search"/>
                   
                      <div className="flex  flex-col md:flex-row basis-4/8 p-3 gap-3 flex-1 items-center justify-center">
                      <button className="button bg-blue-700 text-white rounded-lg border-t-blue-400 border-s-blue-400 border border-b-blue-900 border-e-blue-900 font-bold py-2 px-5 basis-1/1 lg:basis-1/2"><Link href="/admin/suppliers/addnew">ADD NEW SUPPLIER</Link></button>
                      <button className="button bg-yellow-500 text-gray-900 rounded-lg border-t-yellow-200 border-s-yellow-200 border border-b-yellow-700 border-e-yellow-700 font-bold py-2 px-5 basis-1/1 lg:basis-1/2"><Link href="/admin/supplierinvoice">NEW SUPPLIER INVOICE</Link></button>
                      </div>
                      </div>
