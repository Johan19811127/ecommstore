        ...
        <Adminlayout>
                ...
                <div className="flex flex-col items-center justify-items-center h-full">
                    <div className="bg-white rounded-md border border-gray-300 drop-shadow-md w-[90%] min-h-[80vh] mt-5 ">
                      ...
                      <button className="button bg-yellow-500 text-gray-900 rounded-lg border-t-yellow-200 border-s-yellow-200 border border-b-yellow-700 border-e-yellow-700 font-bold py-2 px-5 basis-1/1 lg:basis-1/2"><Link href="/admin/supplierinvoice">SUPPLINVOICE</Link></button>
                      </div>
                      </div>
