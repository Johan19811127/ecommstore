...
9
  ...
  return (
   ...
   <div className="basis-1/2 pe-5" > 
    ...
    <button type="button" 
    onClick={addsize}
    className="w-100 bg-blue-500 text-white font-semibold py-2 px-4 rounded-md hover:bg-blue-600 transition duration-300"> {sizeload ? 'Adding ...' : 'Add Supplier'}</button>
            </div>
          </div>
