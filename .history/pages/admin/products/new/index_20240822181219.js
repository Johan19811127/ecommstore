...
const ProductForm = () => {
  ...
  const [sizload, setSizload]= useState("");
  ...
  const handleAddSize = () => {
    ...
    setSize({ size: '', selling: '', cost: '' }); // Reset after adding
  };
      ...
      <form onSubmit={handleSubmit} className="max-w-6xl mx-auto p-6 bg-white shadow-md rounded-md">
        ...
        <div className="flex flex-row items-center mb-2">
          ...
          <div className="basis-1/12">
            <label className="block text-md font-medium text-gray-700 mx-5 text-center">SKU</label>
          </div>
        ...
        <div className="flex flex-row">
          <div className="basis-1/2 pe-5">
            <div className="mb-4">
              ...
              {formData.sizes.length < 1 ? (
                <p className="text-md px-5 mb-2">You can load as many variances as needed.</p>
              ) : (
                <p className="text-md px-5 mb-2">Please load at least one variance for this product.</p>
              )}
              ...
              <p className="text-md my-1 text-center">This product includes the following variants:</p>
          ...
          <div className="basis-1/2 pe-5">
            ...
            {images.length > 1 ? (
              <p className="text-md px-5 mb-2">You can load up to 6 images per product.</p>
            ) : (
              <p className="text-md px-5 mb-2">Please load at least one picture for this product.</p>
            )}
              ...
              <div className="flex flex-row">
                <div className="basis-3/4 px-3">
                  ...
                  value={imageFiles}
                    ...
                    className="w-full px-3 py-2 text-md border border-gray-300 rounded-md focus:outline-none focus:ring focus:border-blue-500"
                  />
                </div>
            ...
            <div className="container flex flex-row w-[80%] mx-auto gap-3">
              {images.map((image, index) => (
                <div key={index} className="basis-1/3 aspect-[4/5] rounded-lg w-[100%] items-center justify-center">
