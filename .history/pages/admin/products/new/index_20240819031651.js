  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-6xl mx-auto p-6 bg-white shadow-md rounded-md">
      ...
      <div className="basis-1/12 ">
        <label className="block text-sm font-medium text-gray-700 mx-5 text">SKU</label>
        </div>
      ...
      <div className="basis-2/12 ">
        <label className="block text-sm font-medium text-gray-700 mx-5">Supplier</label>
        </div>
        <div className="basis-4/12 ">
        <select
      ...
      <div className="mb-4">
        <label className="block text-sm font-medium text-gray-700 mx-5">SKU</label>
