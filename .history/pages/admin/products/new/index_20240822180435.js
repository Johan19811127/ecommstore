      ...
      <form onSubmit={handleSubmit} className="max-w-6xl mx-auto p-6 bg-white shadow-md rounded-md">
        ...
        <div className="flex flex-row">
          <div className="basis-1/2 pe-5">
            <div className="mb-4">
              ...
              {formData.sizes.length < 1 ? (
                <p className="text-sm px-5 mb-2">You can load as many variances as needed.</p>
              ) : (
                <p className="text-sm px-5 mb-2">Please load at least one variance for this product.</p>
              )}
                ...
                <div className="flex flex-row items-center">
                  ...
                  <div className="basis-2/3">
                    <input
                      ...
                      className="w-full px-3 py-2 border text- border-gray-300 rounded-md focus:outline-none focus:ring focus:border-blue-500 mb-1"
                      required
                    />
                  </div>
                </div>
              ...
              <p className="text-sm my-1 text-center">This product includes the following variants:</p>
              <div className="flex flex-row min-h-[200px] text-center">
               
                {formData.sizes.map((s) => (
                  <div key={s.size} className="px-4 py-2 bg-blue-700 rounded-lg text-white text-sm h-9 mx-1">
                    {s.size}
                  </div>
                ))}
              </div>
          ...
          <div className="basis-1/2 pe-5">
            ...
            {images.length > 1 ? (
              <p className="text-sm px-5 mb-2">You can load up to 6 images per product.</p>
            ) : (
              <p className="text-sm px-5 mb-2">Please load at least one picture for this product.</p>
            )}
