      ...
      <form onSubmit={handleSubmit} className="max-w-6xl mx-auto p-6 bg-white shadow-md rounded-md">
        ...
        <div className="flex flex-row">
          ...
          <div className="basis-1/2 pe-5">
            ...
            <div className="container flex flex-row flex-wrap w-[80%] mx-auto gap-3">
              {images.map((image, index) => (
                <div key={index} className="basis-1/3 aspect-[4/5] rounded-lg w-[100%] flex-none align-items-center justify-content-center">
