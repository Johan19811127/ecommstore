      ...
      <div className="mb-4">
        ...
        <p className="text-sm px-5 mb-2">You can load as many variances as is needed </p>):(<p className="text-sm px-5 mb-2 ">Please load at least one variance for this product.</p>)
          ...
          <div className="flex flex-row  items-center">
            ...
            <div className="text-center flex-flex-row"></div>
    <button type="button" 
    onClick={setSize}
    className="w-100 bg-blue-500 text-white font-semibold py-2 px-4 rounded-md hover:bg-blue-600 transition duration-300">Add Variant</button>
