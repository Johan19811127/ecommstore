  ...
  return (
   ...
   <div className="basis=1/2" > {/* Sizes */}
      <div className="mb-4">
        ...
        <p className="text-sm px-5>Please load at least one variance for this product. </p>):(You can load as many variances as is needed</p>))
      }
        {formData.sizes.map(("> :(<p className="text-sm "size, index) => (
