...
function filterItemsByProd(items, productId) {
  ...
  return (
    <Adminlayout>
    <div className="max-w-4xl mx-auto mt-10 bg-white  p-5 rounded-lg">
 ...
 {supplier && (
  <>
          ...
          <div className="flex-row flex ">
            <div className="basis-1/4 text-end">     <LuPhone   className="w-[25px] h-[25px] mr-3 "/></div>
            <div className="basis-3/4">
          <p className="block text-sm  px-3 text-gray-700  mb-2">{supplier.phone}</p>
          </div>
          </div>
          <div className="flex flex-row">
            <div className="basis-1/4 text-end">   <LuMail   className="w-[25px] h-[25px] mr-3 "/></div>
<div className="basis-3/4">
        ...
        <div className="basis-1/2 px-4 items-start content-start py-1">

        <div className="flex flex-row items-start content-start">
          <div className="basis-1/2">

<label className="block text-sm  mb-1 text-gray-700 mr-5" htmlFor="name">
 Invoice Number:
</label>
</div>
<div className="basis-1/2">
<input  className="form-select text-sm w-full px-3 ml-3 py-1 mb-1 text-gray-700 border border-gray-300 rounded-md focus:outline-none focus:ring focus:border-blue-500"
type="text"
value={docno}
...
<div className="basis-1/2">
<input  className="form-select w-full text-sm px-3 ml-3 py-1 mb-1 text-gray-700 border border-gray-300 rounded-md focus:outline-none focus:ring focus:border-blue-500"
type="date"
value={docdate}
...
<div className="basis-1/2">
<select
  className="form-select text-sm w-full px-3 ml-3 py-1 mb-1 text-gray-700 border border-gray-300 rounded-md focus:outline-none focus:ring focus:border-blue-500"
  value={order}
    ...
    <option key={ord._id} value={ord._id}>
      {ord.number}
        ...
        <div className="mb-4">
          ...
          <h2 className="text-default  font-semibold  text-start  text-gray-700 mb-2">Received Items</h2>
          </div>
          <div className="basis-1/4 content-center items-center">
          <button type="button" className=" bg-gray-200 py-1 text-default font-semibold px-5 mx-auto text-gray-900 mb-3 rounded-md " onClick={addRow}>Add Line</button>
          </div>
          </div>
          <div className="min-h-[300px] w-full">
          <table className="w-full table-fixed mb-4 ">
            <thead className=" text-gray-800 font-medium  w-full ">
              <th className="w-[5%] font-medium text-sm py-1 px-3"></th>
              <th className="w-[35%] border border-gray-400 text-md font-medium  text-start py-1 px-3">Product</th>
              <th className="w-[10%] border border-gray-400 text-sm  font-medium py-1  px-3">Variant</th>
              <th className="w-[10%] border border-gray-400 text-sm font-medium py-1  px-3">Qty</th>
              <th className="w-[15%] border border-gray-400 text-sm font-medium  py-1 px-3  text-end">Cost Price</th>
              <th className="w-[15%] border border-gray-400  text-sm font-medium py-1  px-3 text-end">Subtotal</th>
            </thead>
            <tbody >
            ...
            {rows.map((row, index) => (
            <tr  className="h-auto">
              <td className=" text-center py-1 text-sm">{index + 1}</td>
