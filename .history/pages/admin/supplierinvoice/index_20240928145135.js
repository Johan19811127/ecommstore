        ...
        <div className="mb-4">
          ...
          <table className="w-full table-fixed mb-4 ">
            <thead className="bg-yellow-300 text-gray-800 font-medium w-full">
              ...
              <th className="w-[10%] border border-yellow-700  text-yellow-700 font-medium text-md p-3">Variant</th>
              <th className="w-[10%] border border-yellow-700 text-yellow-700 font-medium text-md p-3">Qty</th>
