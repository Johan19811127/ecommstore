         ...
         <table className="w-full mb-12">
          <tbody>
                      <tr>
                        ...
                        <td  className="w-1/4 text-center text-gray-700 text-lg text-md font-semibold"><h3 className="formheadtext pt-3">Order Total</h3></td>
                        <td className="w-1/4  "><input className="total text-end bg-white text-gray-700 text-lg font-bold pt-3 border-t border-t-black border-b-[3px] border-double border-b-black px-4"
                          type="text"
                          tabIndex="-1"
