         ...
         <table className="w-full mb-12">
          <tbody>
                      <tr>
                        ...
                        <td className="w-1/4  "><input className="total text-end bg-white text-gray-700 text-lg font-bold pt-3 border-t border-t-gray-700 border-b-[3px] border-double border-b-black px-4"
                          type="text"
                          tabIndex="-1"
