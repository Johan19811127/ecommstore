...
<input  className="form-select text-m w-full px-3 ml-3 py-1 mb-2 text-gray-700 border border-gray-300 rounded-md focus:outline-none focus:ring focus:border-blue-500"
type="text"
value={docno}
