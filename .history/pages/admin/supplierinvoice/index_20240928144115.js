         ...
         <table className="w-full mb-12">
          ...
          <div className="flex flex-row gap-6 invoice-btn-section clearfix d-print-none">
            <div className="basis-1/2 px-5 ">
              ...
              <button type="submit" className="px-4 py-2 bg-yellow-400 text-gray-800 rounded-md font-bold text-md w-full text-center border border-b-yellow-600 border-drop-shadow-sm">
                SUBMIT INVOICE
        </button>
            </div>
            </div>
