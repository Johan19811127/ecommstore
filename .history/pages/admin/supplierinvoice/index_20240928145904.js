         ...
         <table className="w-full mb-12">
          <tbody>
                      <tr>
                        ...
                        <td className="w-1/4  "><input className="total text-end bg-white text-gray-600 text-lg font-bold pt-3 border-t border-t-gray-600 border-b-[3px] border-double border-b-gray-700 px-4"
                          type="text"
                          tabIndex="-1"
