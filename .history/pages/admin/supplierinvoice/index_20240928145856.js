         ...
         <table className="w-full mb-12">
          <tbody>
                      <tr>
                        ...
                        <td  className="w-1/4 text-center text-gray-6+00 text-lg font-bold"><h3 className="formheadtext pt-3">Order Total</h3></td>
                        <td className="w-1/4  "><input className="total text-end bg-white text-gray-600 text-lg font-bold pt-3 border-t border-t-gray-700 border-b-[3px] border-double border-b-gray-700 px-4"
                          type="text"
                          tabIndex="-1"
