...
function filterItemsByProd(items, productId) {
  ...
  return (
    ...
    <div className="max-w-4xl mx-auto mt-10 bg-white  rounded-lg">
      ...
      <h1 className="text-2xl font-bold bg-gray-800  text-center">Supplier Invoice</h1></div>
...
<div className="basis-1/3">
 ...
 {supplier && (
  ...
  <div className="flex flex-row mb-2">
        ...
        <div className="basis-1/3"><p className="block text-md text-gray-700  mb-2">Address:</p></div>
        <div className="basis-2/3">
          <p className="block text-md text-gray-700 px-3 leading-tight">{supplier.street}</p>
          <p className="block text-md text-gray-700 px-3 leading-tight">{supplier.city}</p>
          <p className="block text-md text-gray-700 px-3 leading-tight mb-2">{supplier.postalCode}</p>
          </div>
          </div>
          <div className="flex-row flex ">
            <div className="basis-1/3"> <p className="block text-md text-gray-700  mb-2">Phone:</p></div>
            <div className="basis-2/3">
          <p className="block text-md  px-3 text-gray-700  mb-2">{supplier.phone}</p>
          </div>
          </div>
          <div className="flex flex-row">
            <div className="basis-1/3"> <p className="block text-md text-gray-700  mb-2">Email:</p></div>
<div className="basis-2/3">
          <p className="block text-md  px-3 text-gray-700 " >{supplier.email}</p>
          </div>
        </div>
      ...
      {ord.number}
        ...
        <div className="mb-4">
          ...
          <table className="w-full table-fixed mb-4">
            <thead className="bg-gray-300 bg-gray-800 font-medium w-full">
      ...
      {product.name}
         ...
         <table className="w-full mb-12">
          ...
          <button
            ...
            className="px-4 py-2 bg-gray-300 bg-gray-800 rounded-md"
          >
            Add Item
          </button>
        </div>
        <button type="submit" className="px-4 py-2 bg-green-600 bg-gray-800 rounded-md">
          Submit Invoice
        </button>
      </div>
      </form>
