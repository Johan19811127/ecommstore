        ...
        <div className="mb-4">
          ...
          <table className="w-full table-fixed mb-4 ">
            <thead className=" text-gray-800 font-medium border border-gray-600 w-full">
              ...
              <th className="w-[15%] border border-gray-600 font-medium  px-3 px-4 text-end">Cost Price</th>
              <th className="w-[15%] border border-gray-600 font-medium  px-3 px-4 text-end">Subtotal</th>
            </thead>
            <tbody >
