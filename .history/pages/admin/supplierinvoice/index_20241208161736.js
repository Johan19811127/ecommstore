...
<div className="basis-1/2">
<select
  className="form-select text-sm w-full px-3 ml-3 py-1 mb- text-gray-700 border border-gray-300 rounded-md focus:outline-none focus:ring focus:border-blue-500"
  value={order}
