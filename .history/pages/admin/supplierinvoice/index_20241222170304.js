        ...
        <div className="mb-4">
          ...
          <table className="w-full table-fixed mb-4 ">
            <thead className=" text-gray-800 font-medium  w-full ">
              ...
              <th className="w-[10%] border border-gray-400 text-md  font-medium py-1  px-3">Variant</th>
              <th className="w-[10%] border border-gray-400 text-md font-medium py-1  px-3">Qty</th>
