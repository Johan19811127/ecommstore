...
<div className="basis-2/3">
        ...
        <div className="basis-1/2 px-4 items-start content-top py-3">

        <div className="flex flex-row items-start content-top">
          <div className="basis-1/3">
      ...
      {ord.number}
        ...
        <div className="mb-4">
          ...
          <table className="w-full table-fixed mb-4 ">
            <thead className="bg-yellow-300 text-gray-800 font-medium w-full">
              <th className="w-[5%] border border-yellow-600 text-yellow-700 font-medium text-md p-3"></th>
              <th className="w-[35%] border border-yellow-600 text-yellow-700 font-medium text-md text-start p-3">Product</th>
              <th className="w-[10%] border border-yellow-600  text-yellow-700 font-medium text-md p-3">Variant</th>
              <th className="w-[10%] border border-yellow-600 text-yellow-700 font-medium text-md p-3">Qty</th>
              <th className="w-[15%] border border-yellow-600 text-yellow-700 font-medium text-md py-3 px-4 text-end">Cost Price</th>
              <th className="w-[15%] border border-yellow-600 text-yellow-700 font-medium text-md py-3 px-4 text-end">Subtotal</th>
            </thead>
            <tbody >
         ...
         <table className="w-full mb-12">
          <tbody>
                      <tr>
                        ...
                        <td  className="w-1/4 text-center text-gray-700 text-lg font-bold"><h3 className="formheadtext pt-3">Order Total</h3></td>
                        <td className="w-1/4  "><input className="total text-end bg-white text-gray-700 text-lg font-bold pt-3 border-t border-t-gray-700 border-b-[3px] border-double border-b-gray-700 px-4"
                          type="text"
                          tabIndex="-1"
          ...
          <div className="flex flex-row gap-6 invoice-btn-section clearfix d-print-none">
            <div className="basis-1/2 px-5 ">
              ...
              <button type="submit" className="px-4 py-2 bg-yellow-400 text-yellow-800 rounded-md font-bold text-md w-full text-center border border-b-yellow-600 border-t-yellow-200 border-l-yellow-200 border-r-yellow-600 drop-shadow-sm">
                SUBMIT INVOICE
        </button>
            </div>
            </div>
