        ...
        <div className="mb-4">
          ...
          <table className="w-full table-fixed mb-4 ">
            <thead className="bg-yellow-300 text-gray-800 font-medium w-full">
              <th className="w-[5%] border border-yellow- font-medium text-md p-3"></th>
              <th className="w-[35%] border boryellow- font-medium text-md text-start p-3">Product</th>
              <th className="w-[10%] border border-yellow-  font-medium text-md p-3">Variant</th>
              <th className="w-[10%] border border-yellow- font-medium text-md p-3">Qty</th>
              <th className="w-[15%] border border-yellow- font-medium text-md py-3 px-4 text-end">Cost Price</th>
              <th className="w-[15%] border border-yellow- font-medium text-md py-3 px-4 text-end">Subtotal</th>
            </thead>
            <tbody >
