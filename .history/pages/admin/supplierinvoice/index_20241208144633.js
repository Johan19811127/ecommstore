      ...
      {ord.number}
        ...
        <div className="mb-4">
          ...
          <table className="w-full table-fixed mb-4 ">
            <thead className=" text-gray-800 font-medium border border-gray-600 w-full ">
              <th className="w-[5%] border border-gray-600 font-medium  py-1 px-3"></th>
              <th className="w-[35%] border border-gray-600 font-medium  text-start py-1 px-3">Product</th>
              <th className="w-[10%] border border-gray-600  font-medium py-1  px-3">Variant</th>
              <th className="w-[10%] border border-gray-600 font-medium py-1  px-3">Qty</th>
              <th className="w-[15%] border border-gray-600 font-medium  py-1 px-3  text-end">Cost Price</th>
              <th className="w-[15%] border border-gray-600 font-medium py-1  px-3 text-end">Subtotal</th>
            </thead>
            <tbody >
            ...
            {rows.map((row, index) => (
            <tr  className="h-auto">
              <td className=" text-center py-1 text-md">{index + 1}</td>
  ...
  {products.map((product, idx) => (
    <option key={idx} value={product._id}>
      {product.name}
                          ...
                          <td  className=" text-center py-1">
                            <select className="form-select  w-full  text-gray-700  text-center rounded-md focus:outline-none "
                              value={row.size}
                          ...
                          <td  className="  py-1">
                            <input className="form-select  w-full  text-center text-gray-700  rounded-md focus:outline-none "
                              type="number"
                              min="0"
                              max="99999999"
                              value={row.qty || 0}
