        ...
        <div className="mb-4">
          ...
          <table className="w-full table-fixed mb-4 ">
            <thead className=" text-gray-800 font-medium  w-full ">
              ...
              <th className="w-[15%] border border-gray-400 text-md font-medium  py-1 px-3  text-end">Cost Price</th>
              <th className="w-[15%] border border-gray-400  text-md font-medium py-1  px-3 text-end">Subtotal</th>
            </thead>
            <tbody >
