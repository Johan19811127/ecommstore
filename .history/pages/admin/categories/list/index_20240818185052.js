          ...
          <tbody>
            {categories.map((category) => (
              ...
              < DynamicIcon iconName={category.icon} ></DynamicIcon>
                ...
                <td className="px-2 py-4 word-wrap text-sm text-gray-700 px-2 text-justify"><Link href={`/admin/categories/edit/${category._id}`} className="bg-gro-500 font-semibold text-white text-sm px-3 py-2 rounded-lg">EDIT</Link></td>
