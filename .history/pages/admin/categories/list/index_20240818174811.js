          ...
          <tbody>
            {categories.map((category) => (
              ...
              < DynamicIcon iconName={category.icon} ></DynamicIcon>
                ...
                <td className="px-6 py-4 word-wrap text-default text-gray-700 px-5 text-justify"><Link href={`/admin/categories/edit/${category._id}`} className="bg-blue-600 font-bold text-whitepx-5 py-3 rounded-lg">EDIT</Link></td>
