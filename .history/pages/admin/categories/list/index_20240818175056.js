          ...
          <tbody>
            {categories.map((category) => (
              ...
              < DynamicIcon iconName={category.icon} ></DynamicIcon>
                ...
                <td className="px-6 py-4 word-wrap text-default text-gray-700 px-5 text-justify"><Link href={`/admin/categories/edit/${category._id}`} className="bg-blue-400 font-bold text-white text-sm px-5 py-2 rounded-lg">EDIT</Link></td>
                <td className="px-6 py-4 word-wrap text-default text-gray-700 px-5 text-justify"><Link href={`/admin/categories/delete/${category._id}`} className="bg-red-400 font-bold text-white text-sm px-5 py-2 rounded-lg">DELETE</Link></td>
              </tr>
            ))}
          </tbody>
        </table>
