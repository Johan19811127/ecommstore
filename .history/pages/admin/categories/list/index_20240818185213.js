          ...
          <tbody>
            {categories.map((category) => (
              ...
              < DynamicIcon iconName={category.icon} ></DynamicIcon>
                ...
                <td className="px-2 py-4 word-wrap text-sm text-gray-700 px-2 text-justify"><Link href={`/admin/categories/delete/${category._id}`} className="hover:bg-red-500 font-semibold text-white text-sm px-3 py-2 rounded-lg">DELETE</Link></td>
              </tr>
            ))}
          </tbody>
        </table>
