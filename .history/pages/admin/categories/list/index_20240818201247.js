  ...
  return (
    ...
    <div className="max-w-6xl mx-auto p-6">
      ...
      <div className="overflow-x-auto">
        ...
        <p className="text-default text-gray-700 body2 text-center pt-3 mt-3">No categories are currently available. Please add categories by clicking on the button above.</p>
    </Adminlayout>
  );
}
