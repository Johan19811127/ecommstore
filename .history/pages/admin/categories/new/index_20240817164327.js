...
import * as Icons from "react-icons/8";
...
export default function IconSelector() {
  ...
  return (
    ...
    <div className="max-w-lg mx-auto p-6 bg-white shadow-lg rounded-lg">
      <h2 className="text-2xl font-bold mb-4 text-center">Select an Icon</h2>
      <input
        type="text"
        ...
        {iconKeys.map((iconKey) => {
          ...
          return (
            ...
            >
              ...
              <p className="text-xs text-center mt-1 text-gray-600">{iconKey}</p>
            </div>
          );
        })}
      </div>
