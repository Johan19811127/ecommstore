...
const PurchaseOr = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto mt-10 bg-white p-4 rounded-lg"></div>
            ...
            <div className="invoice-inner" id="invoice_wrapper">
              <div className="invoice-top">
                <div className="row">
                  ...
                  <div className="col-sm-6">
                    <div className="invoice text-end">
                ...
                <div className="row">
                  ...
                  <div className="col-sm-6 mb-30">
                    <div className="invoice-number text-start ms-2">
                      ...
                      <div className="row m-0 p-0">
                        <div className="col-2 pe-2 text-center field"><HomeIcon /></div>
                        <div className="col-10">
                          <p className="field py-0 my-0">9 Huising Avenue, Monte Vista, 7460</p>
                        </div>
                      </div>
                      <div className="row m-0 p-0">
                        <div className="col-2 pe-2 text-center field"><PhoneIcon /></div>
                        <div className="col-10">
                          <p className="field py-0 my-0">(021) 558 4637</p>
                        </div>
                      </div>
                      <div className="row m-0 p-0">
                        <div className="col-2 pe-2 text-center field"><DraftsIcon /></div>
