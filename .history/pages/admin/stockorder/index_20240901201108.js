...
const PurchaseOr = () => {
  ...
  const handleChange = (index, text-md text-blue-800, value) => {
    const newRows = [...rows];
    newRows[index][text-md text-blue-800] = value !== undefined ? value : '';

    if (text-md text-blue-800 === 'size') {
    ...
    if (text-md text-blue-800 === 'qty' || text-md text-blue-800 === 'lastCost') {
  ...
  return (
    <>
    <Adminlayout>
    <div className="max-w-4xl mx-auto mt-10 bg-white px-5 py-3 rounded-lg">
    
                <div className="text-center py-4">
                
                      <h1 className="text-3xl font-semibold text-blue-800">Purchase Order</h1>
                    </div>
              ...
              <div className="flex flex-row" >
              <div className="basis-1/2 flex flex-row items-center content-center">
...
<div className="basis-2/3">
          <p className="block text-md  px-3 text-blue-800 " >{supplier.email}</p>
                  ...
                  <div className="basis-1/2 mb-30">
                    <div className="invoice-number text-start ms-2">
                      <h3 className="formheadtext">Invoice Details</h3>
                      <div className="flex-row flex">
                        <div className="basis-1/6"></div>
                        <div className="basis-5/6">
                          <p className="text-md text-blue-800 py-0 my-1">Monte Vista Primary School</p>
                        </div>
                      </div>
                 
                      <div className="flex flex-row">
                        <div className="basis-1/6 pe-2 text-center text-md text-blue-800"><HomeIcon /></div>
                        <div className="basis-5/6">
                          <p className="text-md text-blue-800 py-0 my-0">9 Huising Avenue, Monte Vista, 7460</p>
                        </div>
                      </div>
                      <div className="flex flex-row">
                        <div className="basis-1/6 pe-2 text-center text-md text-blue-800"><PhoneIcon /></div>
                        <div className="basis-5/6">
                          <p className="text-md text-blue-800 py-0 my-0">(021) 558 4637</p>
                        </div>
                      </div>
                      <div className="flex flex-row">
                        <div className="basis-1/6 pe-2 text-center text-md text-blue-800"><DraftsIcon /></div>
