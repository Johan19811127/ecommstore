              ...
              <div className="order-summary">
                ...
                <div className="table-responsive">
                  <table className="table invoice-table">
                    <thead className="bg-active bg-blue-800 text-white py-1 ">
                      <tr className="bg-blue-800 text-white py-2 ">
                        <th className="text-start w-[35%] py-2 px-3 border border-white">Product</th>
                        <th className="text-start w-[15%] py-2 px-3 border border-white">Size</th>
                        <th className="text-center w-[10%] py-2 px-3 border border-white" >Qty</th>
                        <th className="text-right w-[15%] py-2 px-3 border border-white" >Cost</th>
                        <th className="text-right w-[20%] py-2 px-3 border border-white" >Totals</th>
                      </tr>
                    </thead>
                    <tbody className="min-h-[200">
                      {rows.map((row, index) => (
                        <tr key={row.id}>
                          <td>
