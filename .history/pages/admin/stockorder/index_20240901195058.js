...
const PurchaseOr = () => {
  ...
  return (
    ...
    <div className="max-w-4xl mx-auto mt-10 bg-white px-5 py-3 rounded-lg">
          ...
          <div className="border border-slate-300 my-"
                <div className="flex flex-row">
                  <div className="basis-1/2 text-start">
                   
                      <h3 className="text-2xl font-semibold text-blue-800">Invoice Number: #45613</h3>
               
                  </div>
                  <div className="basis-1/2">
                    
                  <h3 className="text-2xl font-semibold text-end text-blue-800">Invoice Date: {new Date().toLocaleDateString()}</h3>
