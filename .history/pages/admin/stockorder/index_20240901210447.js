                  ...
                  <table className="table invoice-table">
                    <thead className="bg-active bg-blue-800 text-white py-2 ">
                      <tr className="bg-blue-800 text-white py-2 ">
                        <th className="text-start w-[35%]">Product</th>
                        <th className="text-start w-[15%]">Size</th>
                        <th className="text-center w-[10%]" >Qty</th>
                        <th className="text-center w-[15%]" style={{ width: '15%' }}>Cost</th>
                        <th className="text-right w-[20%]" style={{ width: '20%' }}>Totals</th>
                      </tr>
                    </thead>
                    <tbody>
                      {rows.map((row, index) => (
