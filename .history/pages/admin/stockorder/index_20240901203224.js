              ...
              <div className="order-summary">
                <div className="row mt-3 pb-2">
                  <div className="col-9 text-start ps-2">
                    <h3 className="formheadtext text-lg font-semibold text-blue-800">Order Details</h3>
                    <p className="text-sm text-blue-800 text-start">Please Note: Only products from the listed supplier or those without a specified supplier are available for selection.</p>
                  </div>
                  <div className="col-2">
