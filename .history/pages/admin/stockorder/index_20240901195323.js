          ...
          <div className="border border-slate-300 my-3"></div>
                <div className="flex flex-row">
                  <div className="basis-1/2 text-start">
                      ...
                      <h3 className="text-xl font-semibold text-blue-800">Invoice Number: #45613</h3>
               
                  </div>
                  <div className="basis-1/2">
                    
                  <h3 className="text-xl font-semibold text-end text-blue-800">Invoice Date: {new Date().toLocaleDateString()}</h3>
                ...
                <div className="flex flex-row">
                  <div className="basis-1/2">
                    <div className="text-start">
                      <h3 className="text-lg font-bold text-blue-800">Supplier Details</h3>
                      <div className="flex flex-row">
