...
<div className="basis-2/3">
          <p className="block text-md  px-3 text-blue-800 " >{supplier.email}</p>
              ...
              <div className="order-summary">
                <div className="flex flex-row">
                  <div className="basis-9/12 text-start ps-2">
                    <h3 className="text-lg font-semibold text-blue-800">Order Details</h3>
                  
                  </div>
                  <div className="basis-3/12">
                    <button type="button" className="gbg-gray-500 py-2 px-5 text-md text-blue-800 font-semibold rounded-lg " style={{ margin: '0px' }} onClick={addRow}>Add Line</button>
                  </div>
                </div>
