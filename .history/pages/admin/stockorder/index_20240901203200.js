              ...
              <div className="order-summary">
                <div className="row mt-3 pb-2">
                  <div className="col-9 text-start ps-2">
                    ...
                    <p className="text-sm text-blue-text-start">Please Note: Only products from the listed supplier or those without a specified supplier are available for selection.</p>
                  </div>
                  <div className="col-2">
