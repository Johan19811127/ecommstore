          ...
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
           ...
           <div className="overflow-hidden whitespace-nowrap">
             <div className="animate-scroll text-default leading-tight font-bold">
              Welcome to the brand new online clothing store for Monte Vista Primary School. One of the big improvements is the ability In order to place an order you have to log in .    
             </div>
           </div>
         </div>
         </>
