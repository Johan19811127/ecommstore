...
const router = useRouter()
  ...
  return (
    ...
    <div className="w-screen p-5 bg-blue-500 border border-t-slate-300 mt-10">
...
<div className="flex flex-col md:flex-row">
   ...
   <Image src="/badge.png" width="200" height="200" alt="Monte Vista Primary School" className=" w-[20vw] md:w-[70%] h-auto mx-auto"></Image>
    ...
    <h5 className="font-bold text-xl mb-4 text-white leading-tight">Monte Vista Primary School </h5>
    <h6 className="font-bold text-xl mb-4 text-white leading-tight">Monte Vista Primary School </h6>
