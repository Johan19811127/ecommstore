...
<div className="items-center content-center">
    ...
    <div className="flex flex-row content-center items-center my-5 gap-3">
                <EmailShareButton url={currentUrl} subject={pro body="body">
                  <EmailIcon size={32} round />
                </EmailShareButton>

                <WhatsappShareButton url={currentUrl} title={pro separator=":: ">
                ...
                <TwitterShareButton url={currentUrl} title={pro>
                  <TwitterIcon size={32} round />
                </TwitterShareButton>

                <RedditShareButton url={currentUr windowWidth={660} windowHeight={460}>
