...
export default function Footer() {
  return (
    ...
    <div className="w-screen p-5 bg-slate-100 border border-t-slate-500 mt-10">
...
<div className="flex flex-col md:flex-row">
   ...
   <Image src="/badge.png" width="200" height="200" alt="Monte Vista Primary School" className=" w-[20vw] md:w-[70%] h-auto mx-auto"></Image>
    ...
    <div className="lg:basis-5/12 content-center items- px-5">
    ...
    <div className="lg:basis-5/12 px-5">
