...
<div className="items-center content-center">
    ...
    <div className="flex flex-row content-center items-center my-5 gap-3">
                <EmailShareButton url={currentUrl} subject="Monte Vista Primary School - Online " body="body">
                  <EmailIcon size={32} round />
                </EmailShareButton>

                <WhatsappShareButton url={currentUrl} title="Monte Vista Primary School - Online " separator=":: ">
                ...
                <TwitterShareButton url={currentUrl} title="Monte Vista Primary School - Online ">
                  <TwitterIcon size={32} round />
                </TwitterShareButton>

                <RedditShareButton url={curre"Monte Vista Primary School - Online " windowWidth={660} windowHeight={460}>
