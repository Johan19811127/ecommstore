...
<div className="flex flex-col md:flex-row">
   ...
   <div className="flex md:flex-row items-center">
    ...
    <div className=" fleX flex-row md:basis-1/4 items-center">
    <p className="text-md align-middle pb-3"><span className="inline-flex mr-3 font-bold items-center ">T:</span>021 558 4637</p>
    
    
    </div>
    <div className=" fleX flex-row md:basis-1/4 items-center">
    <p className="text-md align-middle pb-3"><span className="inline-flex mr-3 font-bold items-center ">E:</span>clothingstore@montevistaps</p>
