...
<div className="flex flex-col md:flex-row">
   ...
   <div className="flex flex-col text-blue-800 ">
    ...
    <p className="text-md align-middle text-blue-800"><span className="inline-flex mr-3 font-bold items-center mb-2 ">Tuesdays:</span>7:30 - 8:15    /  <span className="inline-flex mx-3 font-bold items-center mb-2 ">WED</span> 13:00 - 14:45</p>
   </div>
