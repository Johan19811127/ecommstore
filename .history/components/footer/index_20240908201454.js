...
<div className="container mx-auto lg:w-[1600px] p-4">
<div className="flex flex-col md:flex-row">
    <div className=" basis=4/12 lg:basis-2/12 p-4">
