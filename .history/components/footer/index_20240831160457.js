...
<div className="flex flex-col md:flex-row">
   ...
   <p className="text-md mb-2">Do you need to speak to us? here.</p>
    <div className=" fleX flex-row md:basis-1/3 items-center">
    <p className="text-md align-middle pb-3"><span className="inline-flex mr-3 items-center ">Telephone:</span>021 558 4637</p>
