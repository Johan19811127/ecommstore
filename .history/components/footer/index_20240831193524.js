...
<div className="items-center content-center">
    ...
    <div className="flex flex-row content-center items-center my-5 gap-3">
                <EmailShareButton url={currentUrl} subject="Montevist" body="body">
                  <EmailIcon size={32} round />
                </EmailShareButton>

                <WhatsappShareButton url={currentUrl} title="Montevist" separator=":: ">
                ...
                <TwitterShareButton url={currentUrl} title="Montevist">
                  <TwitterIcon size={32} round />
                </TwitterShareButton>

                <RedditShareButton url={curre"Montevist" windowWidth={660} windowHeight={460}>
