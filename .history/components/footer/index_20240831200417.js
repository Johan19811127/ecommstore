...
<div className="flex flex-col md:flex-row">
   ...
   <Image src="/badge.png" width="200" height="200" alt="Monte Vista Primary School" className=" w-[20vw] md:w-[70%] h-auto mx-auto"></Image>
    ...
    <p className="text-md align-middle text-blue-800 text-end"><span className="inline-flex mr-3 font-bold items-center ">A:</span>7 Huising Avenue, Monte Vista 7460</p>
    ...
    <p className="text-md align-middle text-blue-800 text-end "><span className="inline-flex mr-3 font-bold items-center mb-2 ">T:</span>021 558 4637</p>
