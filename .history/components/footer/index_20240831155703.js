...
<div className="flex flex-col md:flex-row">
   ...
   <div className="flex md:flex-row">
    <div className=" fleX flex-row md:basis-1/3 place-items-center">
    <p className="text-md align-middle PB-3"><span className="inline-flex mr-3 "><BsFillTelephoneFill  className="w-5 h-5"/></span>021 558 4637</p>
