...
<div className="flex flex-col md:flex-row">
   ...
   <div className="flex flex-col text-blue-800 ">
    ...
    <p className="text-md align-middle text-blue-800"><span className="inline-flex mr-3 font-bold items-center mb-2 ">Tuesdays:</span>7:30 am - 8:15 am   /  <span className="inline-flex mx- font-bold items-center mb-2 "></span></p>
   </div>
