...
const router = useRouter()
  ...
  return (
    ...
    <div className="w-screen p-5 bg-blue-900 border border-t-slate-300 mt-10">
        <div className="flex flex-row">

<div className="container mx-auto lg:w-[1800px] p-4">
<div className="flex flex-col md:flex-row">
   
    <div className="lg:basis-3/12 content-center items-center px-5">
    <Image src="/badge.png" width="120" height="120" alt="Monte Vista Primary School" className=" w-[15vw] md:w-[1150px] h-auto mx-auto"></Image>
    <h5 className="font-bold text-xl  text-white leading-tight">Monte Vista Primary School </h5>
    <h6 className="font-semibold text-lg mb-4 text-white leading-tight">Online Store </h6>
    <p className="text-md mb-2 text-white font-semibold text-justify leading-tight">Supporting our learners with quality school wear and merchandise. Every purchase directly benefits the school and helps us continue to provide excellent education and a nurturing environment for our children. All orders include free delivery to Monte Vista learners and come with an easy return policy for your convenience.</p>
    </div>
    <div className="basis-4/12"></div>
    <div className="lg:basis-4/12 content-center items-center px-5">
    <p className="text-md font-semibold text-lg mb-2 text-white md:text-end "> Contact us on:.</p>
 ...
 <FaPhone className="text-xl text-white mr-3 shadow-sm w-5 h-5 ml-auto"/>
    <p className="text-md font-semibold align-middle text-white md:text-end content-center ">021 558 4637</p>
