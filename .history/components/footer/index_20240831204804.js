...
<div className="border border-t-gray-300 my-3 "></div>
   ...
   <div className="w-[20vw] items-center content-center">
    <Image src="/schooljersey.png" width="300" height="300" alt="Monte Vista primary School - Online Store" className="relative float-right bottom-0 right-0 w-[100%] -m-t-10"></Image>
    </div>
    </div>
    </div>
