...
<div className="flex flex-col md:flex-row">
   ...
   <Image src="/badge.png" width="200" height="200" alt="Monte Vista Primary School" className=" w-[20vw] md:w-[70%] h-auto mx-auto"></Image>
    ...
    <p className="text-md mb-2 text-blue-800 text-justify">Supporting our learners with quality school wear and merchandise. Every purchase directly benefits the school and helps us continue to provide excellent education and a nurturing environment for our children. All orders include free delivery to Monte Vista learners and come with an easy return policy for your convenience.</p>
    </div>
    <div className="lg:basis-5/12 content-center items-center px-5">
    <p className="text-md font-semibold text-lg mb-2 text-blue-800 text-end "> Contact us on:.</p>
  
 
    
    <p className="text-md align-middle text-blue-800 text-end "><span className="inline-flex mr-3 font-bold items-center ">T:</span>021 558 4637</p>
    
    
  
    <p className="text-md align-middle text-blue-800 text-end"><span className="inline-flex mr-3 font-bold items-center ">E:</span>clothingstore@montevistaps.co.za</p>
    
    
 
    <p className="text-md align-middle text-blue-800 text-end"><span className="inline-flex mr-3 font-bold items-center mb-2 ">A:</span>7 Huising Avenue, Monte Vista 7460</p>
    
    
  
    <p className="text-md font-semibold text-lg mb-2 text-blue-800 text-end">Our clothing store's trading hours is as follow:
    </p>
    <p className="text-md align-middle text-blue-800 text-end"><span className="inline-flex mr-3 font-bold items-center mb-2 ">TUE:</span>7:30 - 8:15    /  <span className="inline-flex mx-3 font-bold items-center mb-2 ">WED</span> 13:00 - 14:45</p>
   </div>
