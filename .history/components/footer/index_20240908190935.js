...
<div className="flex flex-col md:flex-row">
 ...
 <FaPhone className="text-xl text-white-800 mr-3 shadow-sm w-5 h-5 ml-auto"/>
    <p className="text-md font-semibold align-middle text-slate-800 md:text-end content-center ">021 558 4637</p>
