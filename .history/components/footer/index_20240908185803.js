...
const router = useRouter()
  ...
  return (
    ...
    <div className="w-screen p-5 bg-slate-8900 border border-t-slate-300 mt-10">
...
<div className="flex flex-col md:flex-row">
   ...
   <Image src="/badge.png" width="200" height="200" alt="Monte Vista Primary School" className=" w-[20vw] md:w-[70%] h-auto mx-auto"></Image>
    ...
    <div className="flex flex-row content-center text-end items-center">
 <FaPhone className="text-xl text-slate-700 mr-3 shadow-sm w-5 h-5"/>
    <p className="text-lg font-semibold align-middle text-slate-800 md:text-end content-center ">021 558 4637</p>
