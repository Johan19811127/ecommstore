...
import { LuList , LuHeartHandshake  ,LuBox, LuUser, LuBanknote ,LuLayoutDashboard, LuBarChart2  } from "react-icons/lu";
        ...
        <li className="m-0">
          ...
          <li className="m-0">
            <Link href="/projects" className="flex items-center px-2 py-2 text-md font-semibold text-gray-800 hover:bg-gray-300  rounded-md m-0">
                ...
                <span><LuBarChart className="w-[20px] h-[20px] mr-2"/></span>
                <span className="ml-2 text-gray-900">Users</span>
