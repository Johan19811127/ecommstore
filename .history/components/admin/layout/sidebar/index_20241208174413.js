...
export default function Sidebar() {
  return (
    <aside className="w-64 min-h-screen -mt-2 -mb-2 -ms-2 drop-shadow-lg bg-gray-100 border border-r-2  flex flex-col print:hidden">
      {/* Sidebar Header */}
      ...
      <nav className="flex-1 p-4">
        <p classname="text-lg font-bold mb-4 text-center">MAIN MENU</p>
        <ul className="space-y-1">
          <li>
            <Link href="/" className="flex items-center p-2  text-gray-800 border border-b-gray-400 text-md font-semibold hover:bg-gray-300 rounded-md">
