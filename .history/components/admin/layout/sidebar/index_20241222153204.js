...
export default function Sidebar() {
  return (
    <aside className="w-70 min-h-screen -mt-2 -mb-2 -ms-2 shadow-lg bg-white border border-r-2 border-r-gray-300  flex flex-col print:hidden">
      {/* Sidebar Header */}
      ...
      <div className="p-4 border border-t-gray-300">
        <Link href="/logout" className="flex items-center p-2 text-md font-semibold text-gray-300 hover:bg-gray-700 hover:text-white rounded-md">
