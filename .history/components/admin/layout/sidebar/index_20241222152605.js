...
import { LuList , LuHeartHandshake  ,LuBox, LuUser, LuBanknote ,LuLayoutDashboard  } from "react-icons/lu";
  ...
  return (
    <aside className="w-80 min-h-screen -mt-2 -mb-2 -ms-2 shadow-lg bg-white border border-r-2 border-r-gray-300  flex flex-col print:hidden">
      ...
      <div className="p-5 border border-b-gray-300 border-b-2">
        ...
        <p className="text-md font-bold text-center">MAIN MENU</p>
      </div>
      ...
      <nav className="flex-1 p-4">
        ...
        <li className="m-0">
          ...
          <li className="m-0">
            <Link href="/projects" className="flex items-center px-2 py-2 text-md font-medium text-gray-900 hover:bg-gray-300  rounded-md">
          ...
          <li className="m-0">
            <Link href="/projects" className="flex items-center px-2 py-2 text-md font-medium text-gray-900 hover:bg-gray-300  rounded-md m-0">
          ...
          <li className="m-0">
            <Link href="/projects" className="flex items-center px-2 py-2 text-md font-medium text-gray-800 hover:bg-gray-300  rounded-md m-0">
                ...
                <span><LuBan className="w-[20px] h-[20px] mr-2"/></span>
