...
export default function Sidebar() {
  return (
    <aside className="w-80 min-h-screen -mt-2 -mb-2 -ms-2 shadow-lg bg-white border border-r-2 border-r-slate-500  flex flex-col print:hidden">
      {/* Sidebar Header */}
      <div className="p-4 bg-blue-700">
        <p className="text-sm uppercase text-center text-white">Monte Vista Primary School</p>
