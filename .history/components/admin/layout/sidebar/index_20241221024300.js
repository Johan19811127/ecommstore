    ...
    <aside className="w-80 min-h-screen -mt-2 -mb-2 -ms-2 drop-shadow-lg bg-gray-100 border border-r-2  flex flex-col print:hidden">
      ...
      <nav className="flex-1 p-4">
        ...
        <ul className="space-y-3 divide-y divide-solid ">
          ...
          <li>
            <Link href="/projects" className="flex items-center p-2 text-md font-medium text-gray-800 hover:bg-gray-300  rounded-md">
             
                <span><LuBox className="w-[20px] h-[20px] mr-22"/></span>
                <span className="ml-2 text-gray-800">Stock</span>
