...
export default function Sidebar() {
  return (
    <aside className="w-75 min-h-screen -mt-2 -mb-4 -ms-2 shadow-lg bg-white border border-r-2 border-r-gray-300  flex flex-col print:hidden">
      {/* Sidebar Header */}
      <div className="p-5 border border-b-gray-300 shadow-md border-b-2">
      ...
      {/* Sidebar Footer */}
      <div className="p-4 border shadow-inner border-t-gray-300">
