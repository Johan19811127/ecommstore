...
import { LuList , LuHandshake ,LuBox, LuPhone, LuMailPlus ,LuLayoutDashboard  } from "react-icons/lu";
        ...
        <ul className="space-y-3 divide-y divide-solid ">
          ...
          <li>
            <Link href="/projects" className="flex items-center px-2 py-2 text-md font-medium text-gray-800 hover:bg-gray-300  rounded-md">
                ...
                <span><LuHandshake className="w-[20px] h-[20px] mr-2"/></span>
          ...
          <li>
            <Link href="/projects" className="flex items-center px-2 py-2 text-md font-medium text-gray-800 hover:bg-gray-300  rounded-md">
                ...
                <span className="ml-2 text-gray-800">U</span>
