...
export default function Intro() {
  return (
    ...
    <div className="flex flex-row gap-3 min-h-[50vh]">
        ...
        <p className="text-md  leading-tight text-blue-900 text-justify mb-5">Paid orders received from parents that ordered goods online will be picked and packed and delivered straight to the learners. This ussaully happens with in 3- 5 school days from tday of order.If Goods is unused and in nits original condition it can be exchanged by sending it back with the learner within 7 days from receiving the package to be exchanged for a different size. Refunds will only be appproved on orders where  
