...
export default function Intro() {
  return (
    ...
    <div className="flex flex-row gap-3 h-auto">
        ...
        <Link href="/deliveryprocess" className="inline-block px-6 py-2.5 mt-auto bg-blue-600 text-white font-medium text-medium leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">LEARN MORE</Link>
