...
export default function Intro() {
  return (
    ...
    <div className="container mx-auto lg:w-[1200px] p-4">
        ...
        <h1 className="md:text-3xl font-bold tet-center uppercase mb-3 mt-7 text-blue-900 text-center">Welcome to the Monte Vista Primary School's Online Store</h1>
