...
export default function Intro() {
  return (
    ...
    <div className="flex flex-row gap-3 min-h-[50vh]">
        ...
        <TbTruckDelivery className="h-13 w-13 text-center mx-auto text-blue-900"/>
        <p className="text-lg uppercase font-bold text-blue-900 text-center" >Delivery Policy</p>
