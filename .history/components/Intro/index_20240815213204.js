...
export default function Intro() {
  return (
    ...
    <div className="flex flex-row gap-3 min-h-[50vh]">
        ...
        <p className="text-md  leading-tight text-blue-900 text-justify mb-5">Only fully paid orders will be processed, and no stock will be reserved for orders that are not fully paid. All images and digital assets on this website are the property of Monte Vista Primary School and may not be used without the school's explicit consent. Unauthorized use of images and descriptions for the reproduction of items is strictly prohibited. The school reserves the right to block any user found to be visiting the site for personal gain. Please note that the payment gateway is managed by a third-party provider, and Monte Vista Primary School does not store any payment details on its database.</p> 
