...
export default function Intro() {
  return (
    ...
    <div className="container mx-auto lg:w-[1200px] p-4">
        ...
        <h1 className=" temd:text-3xl font-bold tet-center uppercase mb-3 mt-7 text-blue-900 text-center">Welcome to the Monte Vista Primary School's Online Store</h1>
    ...
    <div className="flex flex-col md:flex-row gap-3 h-auto">
        ...
        <Link href="/deliveryprocess" className="inline-block px-6 py-2.5 mt-auto mb-3 bg-blue-600 text-white font-medium text-medium leading-tight uppercase rounded text-center shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">LEARN MORE</Link>
