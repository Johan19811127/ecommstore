...
export default function Intro() {
  return (
    ...
    <div className="flex flex-row gap-3 min-h-[50vh]">
        ...
        <p className="text-md  leading-tight text-blue-900 text-justify mb-5">The Grade R uniform features the Monte Vista Primary sports top paired with comfortable shorts. Additionally, our young learners will wear the official school tracksuit for cooler days. The uniform for boys in Grades 1-7 includes a classic plain white shirt, complemented by either long or short grey school trousers. This is paired with long grey socks and smart black school shoes.For girls in Grades 1-7, the uniform consists of a school skirt or tailored school slacks, worn with a crisp white shirt, black shoes, and white socks.</p>
