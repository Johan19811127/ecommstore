...
<div className="container bg-slate-100 nflex aspect-square items-center content-center">
<Image src="/schooljersey.png" alt={product.name} width="400" height="400"></Image>

</div>
<div className="container px-3 py-2">
<p className="text-2xl font-bold text-center my-2 font-sans	antialiased  uppercase">{product.name}</p>
</div>
</div>
