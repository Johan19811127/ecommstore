...
<div className="grid lg:grid-cols-3 gap-1 align-items-center ">

{products.map((product) => (

<div className="container m-1 border rounded-xl">

<div className="container bg-slate-100 flex aspect-square items-center content-center">
<Image src="/schooljersey.png" alt={product.name} width="400" height="400"></Image>
