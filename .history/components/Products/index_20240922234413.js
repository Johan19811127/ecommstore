...
export default function Products() {
  ...
  <h1 className="text-xl md:text-3xl font-bold text-center uppercase mb-3 mt-7 text-blue-800">OUR PRODUCTS</h1>
      ...
      <div key={product._id} className="container m-1 border-b border-slate-200 shadow-md rounded-xl">
        <Link href={`/products/${product._id}`}>
          <div className="container bg-slate-100 flex items-center justify-center rounded-t-xl border border-b-slate-200">
            <div className="relative w-full aspect-[16/3]"> {/* Ensuring a consistent aspect ratio */}
              {product.images && product.images[0] && (
                <Image
                  ...
                  layout="fill"
                  objectFit="cover"
                  className="dropshadow-xl rounded-t-xl"
                />
              )}
            </div>
          </div>
