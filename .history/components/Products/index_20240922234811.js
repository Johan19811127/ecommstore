      ...
      <div key={product._id} className="container m-1 border-b border-slate-200 shadow-md rounded-xl">
        <Link href={`/products/${product._id}`}>
          ...
          <div className="container px-5 py-5">
            <p className="text-md lg:text-lg font-semibold font-sans antialiased leading-tight uppercase text=gray-800">{product.name}</p>
            <p className="text-2xl font-semibold text=gray-800 antialiased text-end">
