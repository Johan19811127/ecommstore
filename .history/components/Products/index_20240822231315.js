...
<div className="container flex ratio-4/5 items-center content-center">
<Image src={product.images[0]} alt={product.name} width="400" height="500"></Image>

</div>
<div className="container px-3 py-2">
<p className="text-lg font-bold text-center my-2 font-sans	antialiased  capitalized">{product.name}</p>
</div>
</div>
