      ...
      <div key={product._id} className="container m-1 border-b border-slate-200 shadow-md rounded-xl">
        <Link href={`/products/${product._id}`}>
          ...
          <div className="container px-5 py-5">
            <p className="text-lg lg:text-xl font-semibold antialiased lg:text-cemter leading-tight uppercase text=gray-800">{product.name}</p>
            <p className="text-xl font-bold text=gray-800 antialiased text-end">
