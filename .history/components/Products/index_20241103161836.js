...
<span className="text-xs align-super">From R</span>
{Number(minSellingPrice).toFixwed(2)}
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-4 align-items-center">
      ...
      <div key={product._id} className="container m-1 border-b border-slate-200 shadow-md rounded-xl">
        <Link href={`/products/${product._id}`}>
          ...
          <div className="container px-5 py-5">
            <p className="text-lg lg:text-xl font-semibold antialiased lg:text-center leading-tight uppercase text-slate-800 truncate">{product.name}</p>
