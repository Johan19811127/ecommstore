        ...
        {products.map((product) => (
          <div key={product._id} className="container m-1 border-b border-slate-200 shadow-md rounded-xl">
            ...
            <div className="container px-5 py-5">
              <p className="text-lg font-bold  font-sans antialiased uppercase text-blue-900">{product.name}</p>
              <div className="text-lg font-semibold  text-blue-950 antialiased text-end">
