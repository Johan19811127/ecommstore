...
export default function Products() {
  ...
  // Example usage
  getProductSellingPriceRange('productIdHere')
    .then(priceRange => {
...
<div className="container m-1 border rounded-xl">

<div className="container bg-slate-200 flex aspect-square items-center content-center">
<Image src={product.images[1]} alt={product.name} width="400" height="400"></Image>

</div>
<div className="container px-3 py-2">
<p className="text-xl font-bold drop-shadow-md my-2 font-sans	antialiased  uppercase">{product.name}</p>
<div className="bg-blue-500 text-md font-medium py-1 px-5 text0-end">{getProductSellingPriceRange(product._id)}</div>
</div>
</div>
