        ...
        {products.map((product) => (
          <div key={product._id} className="container m-1 border-b border-slate-200 shadow-md rounded-xl">
            ...
            <div className="container px-5 py-2">
              ...
              <div className="text-lg font-semibold  mb-3 antialiased text-end">
                {getPrice(product._id)}
              </div>
              <p className="text-sm text-gray-500 antialiased mb-3 text-center">Click for more informtion</p>
            </div>
          </div>
        ))}
      </div>
