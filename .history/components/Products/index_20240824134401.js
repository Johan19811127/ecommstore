        ...
        {products.map((product) => (
          <div key={product._id} className="container m-1 border-b border-slate-200 shadow-md rounded-xl">
            ...
            <div className="container px-5 py-5">
              <p className="text-md font-semibold  font-sans antialiased uppercase text-blue-900">{product.name}</p>
              <div className="text-lg font-semibold  text-blue-900 antialiased text-end">
